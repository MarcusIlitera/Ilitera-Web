...
{
    public partial class DadosEmpregado_Guia_Dup : System.Web.UI.Page
    {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (cmb_Clinicas2.Items.Count > 0)
            {
                if (cmb_Clinicas2.SelectedIndex < 0)
                {
                    cmb_Clinicas2.SelectedIndex = 0;
                    lbl_Id_Clinica.Text = cmb_Clinicas2.SelectedValue.ToString().Trim();
                }
                else
                {
                    bool zSelecao = true;
                    for ( int zAux=0; zAux<lst_Exames.Items.Count;zAux++)
                    {
                        if (lst_Exames.Items[zAux].Selected == false) zSelecao = false;
                    }

                    if (zSelecao == true)
                    {
                        if (cmb_Clinicas2.SelectedValue.ToString().Trim() != lbl_Id_Clinica.Text || rd_Mudanca2.Checked == true)
        ...
        private void PopularFindClinica()
        {
            ...
            cmb_Clinicas2.DataSource = dsClinica;
            ...
            cmb_Clinicas2.DataValueField = "Id";
            cmb_Clinicas2.DataTextField = "Nome";
            cmb_Clinicas2.DataBind();

            if (cmb_Clinicas2.Items.Count > 0)
            {
                cmb_Clinicas2.SelectedIndex = 0;
                lbl_Id_Clinica.Text = cmb_Clinicas2.SelectedValue.ToString().Trim();
                PopularValueListClinicaClienteExameDicionario2(cmb_Clinicas2.SelectedValue);
            }    
        ...
        protected void cmb_Clinicas2_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmb_Clinicas2.SelectedIndex >= 0)
            {
                PopularValueListClinicaClienteExameDicionario2(cmb_Clinicas2.SelectedValue);
        ...
        protected void cmb_Clinicas_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lst_Id_Exames.Items.Clear();
            }
        }


        private void PopularValueListClinicaClienteExameDicionario2(string xValue)
        {
            ...
            lbl_Fone_Clinica2.Text = "";
            lbl_Fone_Clinica2.Text = xClinica.GetContatoTelefonico().DDD + " " + xClinica.GetContatoTelefonico().Numero;

            if (lbl_Fone_Clinica2.Text.Trim() != "")
                lbl_Fone_Clinica2.Text = lbl_Fone_Clinica2.Text + "    ";

            lbl_Fone_Clinica2.Text = lbl_Fone_Clinica2.Text + xClinica.GetContatoTelefonico2().DDD + " " + xClinica.GetContatoTelefonico2().Numero;
            lbl_Fone_Clinica2.Text = "Tel.: " + lbl_Fone_Clinica2.Text;


            lbl_email2.Text = xClinica.Email.Trim();



            if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().IndexOf("Prajna") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().ToUpper().Trim() == "OPSA" || Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().ToUpper().IndexOf("MAPPAS") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().ToUpper().IndexOf("GLOBAL") > 0)  
            {

                if (lbl_email2.Text.Trim() == "")
                {
                    chk_eMail2.Checked = false;
                    chk_eMail2.Enabled = false;
                }
                else
                {
                    chk_eMail2.Enabled = true;
                    if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().IndexOf("Prajna") > 0)
                    {
                        chk_eMail2.Checked = true;
                    }
                    else
                    {
                        chk_eMail2.Checked = false;
            ...
            {
                lbl_Horario2.Text = "Horário Atendimento :  " + xClinica.HorarioAtendimento.ToString();
            }

            lbl_End_Clinica2.Text = "";

            lbl_End_Clinica2.Text = xClinica.GetEndereco().IdTipoLogradouro + " " + xClinica.GetEndereco().Logradouro + " " + xClinica.GetEndereco().Numero.ToString() + " " + xClinica.GetEndereco().Complemento;
            lbl_End_Clinica2.Text = lbl_End_Clinica2.Text + "  -  " + xClinica.GetEndereco().IdMunicipio + " / " + xClinica.GetEndereco().Uf;

            lbl_End_Clinica2.Text = "End.: " + lbl_End_Clinica2.Text;
        ...
        private void PopularValueListClinicaClienteExameDicionario(string xValue)
        {
            ...
            if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().IndexOf("Prajna") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().ToUpper().Trim() == "OPSA" || Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().ToUpper().IndexOf("MAPPAS") > 0) 
            {
            ...
            if (pcmso.IdLaudoTecnico != null)
            {
                ...
                //PcmsoPlanejamento x = new PcmsoPlanejamento();


                //string xExames = ghe.GetExamesComplementares(pcmso);

                //string xExames2 = ghe.GetExamesComplPeriodicidade(pcmso);
                //DataSet x = exame.GetExamesComplementaresSomentePreventivos();
                ...
                if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().IndexOf("Daiti") > 0)
                {
                    if (rd_Demissional.Checked == true)
                    {
                        if (zDesconsiderar == false)
                            sExamesASO = exame.GetPlanejamentoExamesAso_Formatado_Asterisco(ghe, false, false, xDataBranco, zDesconsiderar);
                        else
                            sExamesASO = exame.GetPlanejamentoExamesAso_Formatado_Asterisco_Desconsiderar(ghe, false, false, exame, cliente.Dias_Desconsiderar);
                    }
                    else
                    {
                        if (zDesconsiderar == false)
                            sExamesASO = exame.GetPlanejamentoExamesAso_Formatado_Asterisco(ghe, false, cliente.Exibir_Datas_Exames_ASO, xDataBranco, zDesconsiderar);
                        else
                            sExamesASO = exame.GetPlanejamentoExamesAso_Formatado_Asterisco_Desconsiderar(ghe, false, cliente.Exibir_Datas_Exames_ASO, exame, cliente.Dias_Desconsiderar);
                    }
                }
                ...
                if (ghe == null)
                {
                    MsgBox1.Show("Ilitera.Net", "Colaborador não está alocado em GHE,  não é possível criar Guia de Encaminhamento/ASO.", null,
                                          new EO.Web.MsgBoxButton("OK"));                    
                    btnEmpComp.Visible = false;
                    btnEmpASO.Visible = false;
                    return;
                }


                if (rd_Mudanca2.Checked == true || rd_Mudanca.Checked == true)
                {
                    // procurar ghe_ant primeiro, na mesma classif.funcional
                    // se nao encontrar, procurar classif.funcional anterior e ghe
                    ...
                    else
                    {
                        ...
                        if (cliente.GHEAnterior_MudancaFuncao == true)
                        {
                            ...
                            if (xdS.Tables[0].Rows.Count < 2)
                            {
                                rd_Outro2.Checked = true;
                                rd_Mudanca2.Checked = false;
                                MsgBox1.Show("Ilitera.Net", "O empregado " + empregado.tNO_EMPG
                                       + " está associado a apenas um GHE/Classif.Funcional, logo, não é possível gerar o ASO de Mudança de Risco. ", null,
                                              new EO.Web.MsgBoxButton("OK"));
                                return;
                            ...
                            rows[0]["Nome"].ToString().Trim().ToUpper() != "PERIÓDICO")
                        {
                            ...
                            if (sExamesOcupacionais.ToUpper().IndexOf(Convert.ToString(rows[0]["Nome"]).ToUpper()) > 0)
                            {
                                ...
                                if (xPosit == 0)
                                {
                                    ...
                                    lst_Id_Exames.Items.Add(rows[0][0].ToString());
                                }
                                //lst_Exames.Items.Add(Convert.ToString(rows[0]["Nome"]));
                                //lst_Exames.Items[lst_Exames.Items.Count - 1].Selected = true;
                            }
        ...
        protected void btnempASO_Click(object sender, EventArgs e)    
        {
            ...
            //string Aviso_Bloqueio = "N";


            if (Validar_Data(txt_Data2.Text) == false)
            {
                return;
            }


            if (rd_Outro2.Checked == true)
            {
            ...
            string xEmail = lbl_email2.Text.Trim();
            ...
            if (chk_Data2.Checked == false) xImpDt = "N";
            ...
            xObs = txt_Obs2.Text.Trim();

            xObs = xObs + "  Observar exames complementares realizados para a avaliação clínica";
            ...
            if (rd_Admissao2.Checked == true)
            {
                xTipo = "A";
            }
            else if (rd_Demissional2.Checked == true)
            {
                xTipo = "D";
            }
            else if ( rd_Mudanca2.Checked == true)
            {
                xTipo = "M";
            }
            else if ( rd_Outro2.Checked == true)
            {
                xTipo = "O";
            }
            else if ( rd_Periodico2.Checked == true)
            {
                xTipo = "P";
            }
            else if ( rd_Retorno2.Checked == true)
            {
                xTipo = "R";
            }
            ...
            rexame.Find(" IDEMPREGADO = " + Request["IdEmpregado"].ToString() + " and IdExameDicionario = " + xTipoExame.ToString() + " and convert( char(10),DataExame,103 ) = '" + txt_Data2.Text + "' ");
            ...
            if (Ilitera.Data.SQLServer.EntitySQLServer._LocalServer.ToString().ToUpper().IndexOf("EY") > 0)
            {
                ...
                if (xUsuario != "EY_LUCAS" && xUsuario != "EY_ALBERTO" && xUsuario != "EY_RENAN" && xUsuario != "EY_VANESSA")
                {
                    ...
                    ArrayList nExame = new ExameBase().Find(" IDEMPREGADO = " + Request["IdEmpregado"].ToString() + " and IdExameDicionario in ( 1,2,3,4,5 )  and  DataExame < convert( smalldatetime, '" + txt_Data2.Text + "', 103 ) and IndResultado  not in ( 1, 2 )  ");
            ...
            if (xTipo.ToUpper().Trim() == "D" || xTipo.ToUpper().Trim() == "P")
            {
                ...
                //  rexame2.Find(" IDEMPREGADO = " + Request["IdEmpregado"].ToString() + " and IdExameDicionario in ( 1,2,3,4,5 )  and  datediff(day, DataExame, convert( smalldatetime,'" + txt_Data2.Text + "', 103 )) <= 90 and IndResultado <> 0 ");

                ArrayList nExame = new ExameBase().Find(" IDEMPREGADO = " + Request["IdEmpregado"].ToString() + " and IdExameDicionario in ( 1,2,3,4,5 )  and  datediff(day, DataExame, convert( smalldatetime,'" + txt_Data2.Text + "', 103 )) <= "  + zDiasGrauRisco + " and IndResultado  not in ( 0, 3 )  ");               
                                ...
                                if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().IndexOf("Daiti") > 0)
                                {
                                    ...
                                    if (cliente.Bloquear_ASO_Planejamento == false)
                                    {
                                        MsgBox1.Show("Ilitera.Net", "Último exame dentro da validade. Dúvidas, entrar em contato com a central de atendimento no e-mail agendamento.sp.dai@ilitera.com.br", null,
                                            new EO.Web.MsgBoxButton("Ok", null, "Fechar"));
                                        //new EO.Web.MsgBoxButton("Não quero realizar o exame", null, "Fechar"),
                                        //                               new EO.Web.MsgBoxButton("Quero Agendar o Exame mesmo assim", null, "Quero Agendar o Exame mesmo assim"));
                                        return;
                                    }
            ...
            //if (chk_apt_Confinado.Checked == true && chk_apt_Altura.Checked == true && chk_apt_Transportes.Checked == true)
            //{
            //    xAptidao = "1";
            //    //xAptidao = "O empregado está apto para trabalho em altura, apto para trabalho em espaços confinados e apto para operar equipamentos de transporte motorizado.";
            //}
            //else if (chk_apt_Confinado.Checked == true && chk_apt_Altura.Checked == true && chk_apt_Transportes.Checked == false)
            //{
            //    xAptidao = "2";
            //    //xAptidao = "O empregado está apto para trabalho em altura e apto para trabalho em espaços confinados.";
            //}
            //else if (chk_apt_Confinado.Checked == true && chk_apt_Altura.Checked == false && chk_apt_Transportes.Checked == false)
            //{
            //    xAptidao = "3";
            //    //xAptidao = "O empregado está apto para trabalho em espaços confinados.";
            //}
            //else if (chk_apt_Confinado.Checked == false && chk_apt_Altura.Checked == true && chk_apt_Transportes.Checked == true)
            //{
            //    xAptidao = "4";
            //    //xAptidao = "O empregado está apto para trabalho em altura e apto para operar equipamentos de transporte motorizado.";
            //}
            //else if (chk_apt_Confinado.Checked == false && chk_apt_Altura.Checked == true && chk_apt_Transportes.Checked == false)
            //{
            //    xAptidao = "5";
            //    //xAptidao = "O empregado está apto para trabalho em altura.";
            //}
            //else if (chk_apt_Confinado.Checked == false && chk_apt_Altura.Checked == false && chk_apt_Transportes.Checked == true)
            //{
            //    xAptidao = "6";
            //    //xAptidao = "O empregado está apto para operar equipamentos de transporte motorizado.";
            //}
            ...
            xGuia.Salvar_Dados_Guia_Encaminhamento(System.Convert.ToInt32(Request["IdEmpresa"].ToString()), System.Convert.ToInt32(Request["IdEmpregado"].ToString()), xTipo, xExames + "|" + xExames2 + "|" + xExames3 + "|" + xExames4, txt_Data2.Text, txt_Hora2.Text, cmb_Clinicas2.Items[cmb_Clinicas.SelectedIndex].ToString(), user.IdUsuario, "N", rData.Substring(0, 10), rData.Substring(11), txt_Obs2.Text.Trim());
            ...
            if (Ilitera.Data.SQLServer.EntitySQLServer.xDB1.ToString().Trim().ToUpper() == "OPSA")
            {
                if (xTipo.ToUpper().Trim() == "D")
                {
                    ...
                    //xDem.Guia_Demissao_Colaborador(System.Convert.ToInt32(Request["IdEmpregado"].ToString()), txt_Data2.Text);
                    xDem.Guia_Demissao_Colaborador_Obras(System.Convert.ToInt32(Request["IdEmpregado"].ToString()), txt_Data2.Text);
    ...
    + "&IdEmpresa=" + Request["IdEmpresa"] + "&IdEmpregado=" + Request["IdEmpregado"] + "&E1=" + xExames + "&E2=" + xExames2 + "&E3=" + xExames3 + "&E4=" + xExames4 + "&IdClinica=" + cmb_Clinicas2.SelectedValue.ToString() + "&H_E=" + txt_Hora2.Text + "&D_E=" + txt_Data2.Text + "&Tipo=" + xTipo + "&Basico=" + xBasico + "&Mail=" + xEnvio_Email + "&TipoGuia=1" + "&ImpDt=" + xImpDt + "&Apt=" + xAptidao, "RelatorioGuia", true);
        ...
        protected void Gerar_Guia()
        {
            ...
            Ilitera.Data.PPRA_EPI xGuia = new Ilitera.Data.PPRA_EPI();
            xGuia.Salvar_Dados_Guia_Encaminhamento(System.Convert.ToInt32(Request["IdEmpresa"].ToString()), System.Convert.ToInt32(Request["IdEmpregado"].ToString()), xTipo, xExames + "|" + xExames2 + "|" + xExames3 + "|" + xExames4, txt_Data2.Text, txt_Hora2.Text, cmb_Clinicas2.Items[cmb_Clinicas.SelectedIndex].ToString(), user.IdUsuario, "S", rData.Substring(0, 10), rData.Substring(11), txt_Obs2.Text.Trim());
    ...
    + "&IdEmpresa=" + Request["IdEmpresa"] + "&IdEmpregado=" + Request["IdEmpregado"] + "&E1=" + xExames + "&E2=" + xExames2 + "&E3=" + xExames3 + "&E4=" + xExames4 + "&IdClinica=" + cmb_Clinicas2.SelectedValue.ToString() + "&H_E=" + txt_Hora2.Text + "&D_E=" + txt_Data2.Text + "&Tipo=" + xTipo + "&Basico=" + xBasico + "&Mail=" + xEnvio_Email + "&TipoGuia=1" + "&ImpDt=" + xImpDt + "&Apt=" + xAptidao, "RelatorioGuia", true);
        ...
        protected void btnempComp_Click(object sender, EventArgs e)
        {
            int xAux;
            string xExames = "";
            string xExames2 = "";
            ...
            if (xCliente.Gerar_Complementares_Guia == true)
            {
                ...
                for (int nCont = 0; nCont < lst_Id_Exames.Items.Count; nCont++)
                {

                    //checar se exame já existe
                    Int32 xIdExameDicionario = System.Convert.ToInt32(lst_Id_Exames.Items[nCont].ToString());
            ...
            Ilitera.Data.PPRA_EPI xGuia = new Ilitera.Data.PPRA_EPI();
            xGuia.Salvar_Dados_Guia_Encaminhamento(System.Convert.ToInt32(Request["IdEmpresa"].ToString()), System.Convert.ToInt32(Request["IdEmpregado"].ToString()), xTipo, xExames + "|" + xExames2 + "|" + xExames3 + "|" + xExames4, txt_Data.Text, txt_Hora.Text, cmb_Clinicas.Items[cmb_Clinicas.SelectedIndex].ToString(), user.IdUsuario, "N", rData.Substring(0, 10), rData.Substring(11), txt_Obs2.Text.Trim());
    ...
    + "&IdEmpresa=" + Request["IdEmpresa"] + "&IdEmpregado=" + Request["IdEmpregado"] + "&E1=" + xExames + "&E2=" + xExames2 + "&E3=" + xExames3 + "&E4=" + xExames4 + "&IdClinica=" + cmb_Clinicas.SelectedValue.ToString() + "&H_E=" + txt_Hora.Text + "&D_E=" + txt_Data.Text + "&Tipo=" + xTipo + "&Basico=" + xBasico + "&Mail=" + xEnvio_Email + "&ImpDt=" + xImpDt + "&IdEmprFunc=" + rEmprFuncao.Id.ToString().Trim(), "RelatorioGuia", true);
        ...
        protected void rd_Admissao2_CheckedChanged(object sender, EventArgs e)
        {
            //PopularValueListClinicaClienteExameDicionario(cmb_Clinicas2.SelectedValue);
        }

        protected void rd_Demissional2_CheckedChanged(object sender, EventArgs e)
        {
            //PopularValueListClinicaClienteExameDicionario(cmb_Clinicas2.SelectedValue);
        }

        protected void rd_Mudanca2_CheckedChanged(object sender, EventArgs e)
        {
           // PopularValueListClinicaClienteExameDicionario(cmb_Clinicas2.SelectedValue);
        }

        protected void rd_Retorno2_CheckedChanged(object sender, EventArgs e)
        {
            //PopularValueListClinicaClienteExameDicionario(cmb_Clinicas2.SelectedValue);
        }

        protected void rd_Periodico2_CheckedChanged(object sender, EventArgs e)
        {
            //PopularValueListClinicaClienteExameDicionario(cmb_Clinicas2.SelectedValue);
        }
