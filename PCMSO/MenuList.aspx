<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="MenuList.aspx.cs"  Inherits="Ilitera.Net.PCMSO.MenuList" Title="Ilitera.Net" %>
	...
	<body bottomMargin="0" bgColor="#ffffff" leftMargin="0" topMargin="0" rightMargin="0">
		<form method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="150" bgColor="#006600"
				...
				<TR>
					<TD vAlign="top" width="150" bgColor="#006600" height="100%"><iglbar:ultraweblistbar id="UltraWebListbarMenu" runat="server"
							GroupSpacing="10px" ViewType="ExplorerBar" ItemIconStyle="SmallWithInsetText" MergeStyles="True" BarWidth="100%"
							BorderStyle="None" Width="150px" Height="0px" HeaderClickAction="None">
