<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site1.Master" CodeBehind="ListaEmpregado_Digitalizado.aspx.cs"  Inherits="Ilitera.Net.PCMSO.ListaEmpregado_Digitalizado" Title="Ilitera.Net" %>
            ...
            <ig:SplitterPane Size="80%" Style="padding: 5px;" BackColor="#edffeb">
                <Template>
                    ...
                    &nbsp;&nbsp;<br />
                        ...
                        <span class="style1">Exames Digitalizados - Lista de Empregados:</span>
