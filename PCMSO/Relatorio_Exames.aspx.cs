    ...
    public partial class Relatorio_Exames : System.Web.UI.Page
    {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Session["ExceptionType"] = "Apenas usuários de perfil médico podem acessar esse relatório";
                    Session["Source"] = "Relatório Clientes x Exames";

                    Session["Message"] = "Apenas usuários de perfil médico podem acessar esse relatório";
                    Server.Transfer("~/Tratar_Excecao.aspx");
                    return;
                }
