...
{
    public partial class AnamneseAud : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
				...
				RptAudiometria report = new DataSourceAudiometria(audiometria).GetReport(false);

                Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType(), string.Empty, "AnamneseAudiologica");
