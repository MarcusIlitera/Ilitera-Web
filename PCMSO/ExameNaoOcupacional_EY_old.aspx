<%@ Page Title="Ilitera.Net" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True"
    CodeBehind="ExameNaoOcupacional_EY_old.aspx.cs" Inherits="Ilitera.Net.ExameNaoOcupacional_EY_Old" %>
				...
				<TR>
					<TD align="center"><%--                                            <eo:StaticColumn HeaderText="Resultado" AllowSort="True" 
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="defaultFont" width="400">
                            <tr>
                                ...
                                <td align="center" width="134">
                                    <asp:Label ID="lblAltura" runat="server" CssClass="boldFont" SkinID="BoldFont">Altura</asp:Label>
                                </td>
                                <td align="center" width="133">
                            ...
                            <tr>
                                <td align="center" width="133">
                                    <asp:TextBox ID="wdtDataExame" runat="server" CssClass="inputBox" DisplayModeFormat="dd/MM/yyyy" HorizontalAlign="Center" ImageDirectory=" " Nullable="False" Width="113px"></asp:TextBox>
                                </td>
                                <td align="center" width="134">
                                    <asp:TextBox ID="wneAltura" runat="server" AutoPostBack="True" CssClass="inputBox" DataMode="Float" Nullable="False" Width="114px">0</asp:TextBox>
                                </td>
                                <td align="center" width="133">
                                    <asp:TextBox ID="wnePeso" runat="server" AutoPostBack="True" CssClass="inputBox" DataMode="Float" Nullable="False" Width="113px">0</asp:TextBox>
                                </td>
                                <td align="center" width="133">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="defaultFont" width="400">
                            <tr>
                                <td align="center" width="133">
                                    <asp:Label ID="lblPA" runat="server" CssClass="boldFont" SkinID="BoldFont">PA(mmHg)</asp:Label>
                                </td>
                                <td align="center" width="134">
                                    <asp:Label ID="lblPulso" runat="server" CssClass="boldFont" SkinID="BoldFont">Pulso</asp:Label>
                                </td>
                                <td align="center" width="133">
                                    <asp:Label ID="lblTemperatura" runat="server" CssClass="boldFont" SkinID="BoldFont">Temperatura</asp:Label>
                                </td>
                                <td align="center" width="133">
                                    <asp:Label ID="Label5" runat="server" CssClass="boldFont" SkinID="BoldFont">Indíce de Glicose</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" width="133">
                                    <asp:TextBox ID="wtePA" runat="server" CssClass="inputBox" Width="113px">0</asp:TextBox>
                                </td>
                                <td align="center" width="134">
                                    <asp:TextBox ID="wnePulso" runat="server" CssClass="inputBox" DataMode="Int" Nullable="False" Width="114px">0</asp:TextBox>
                                </td>
                                <td align="center" width="133">
                                    <asp:TextBox ID="wneTemperatura" runat="server" CssClass="inputBox" DataMode="Float" Nullable="False" Width="113px">0</asp:TextBox>
                                </td>
                                <td align="center" width="133">
                                    <asp:TextBox ID="txtGlicose" runat="server" CssClass="inputBox" DataMode="Float" MaxLength="20" Nullable="False" Width="113px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblMedico1" runat="server" CssClass="boldFont" SkinID="BoldFont">Histórico de Doenças de Primárias:</asp:Label>
                        </span>&nbsp;&nbsp;
                        <asp:TextBox ID="txt_Historico" runat="server" CssClass="inputBox" MaxLength="100" Nullable="False" Width="230px"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label6" runat="server" CssClass="boldFont" SkinID="BoldFont">Queixa Principal:</asp:Label>
                        &nbsp;&nbsp;
                        <asp:TextBox ID="txt_Queixas" runat="server" CssClass="inputBox" DataMode="Float" MaxLength="50" Nullable="False" Width="210px"></asp:TextBox>
                        &nbsp;&nbsp;
                        <asp:Label ID="Label7" runat="server" CssClass="boldFont" SkinID="BoldFont">Outras Queixas:</asp:Label>
                        &nbsp;&nbsp;
                        <asp:TextBox ID="txt_Outras_Queixas" runat="server" CssClass="inputBox" DataMode="Float" MaxLength="50" Nullable="False" Width="210px"></asp:TextBox>
                        ...
                        &nbsp;<asp:TextBox ID="txt_Alergia" runat="server" CssClass="inputBox" DataMode="Float" MaxLength="40" Nullable="False" Width="120px"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;
                        ...
                        &nbsp;<asp:TextBox ID="txt_Medicacao" runat="server" CssClass="inputBox" DataMode="Float" MaxLength="40" Nullable="False" Width="120px"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="lblMedico0" runat="server" CssClass="boldFont" SkinID="BoldFont">Diagnóstico da Enfermagem</asp:Label>
                        <br>
                        ...
                        <br />
                        &nbsp;<br>
                        <asp:Label ID="Label11" runat="server" CssClass="boldFont" SkinID="BoldFont">Planejamento Assistência de Enfermagem</asp:Label>
                        <br>
                        ...
                        <br />
                        <br />
                        <asp:Label ID="lblAnotacoes0" runat="server" CssClass="boldFont" SkinID="BoldFont">Implementação</asp:Label>
                        <br />
                        &nbsp;<asp:TextBox ID="txt_Implementacao" runat="server" CssClass="inputBox" MaxLength="500" Rows="3" tabIndex="1" TextMode="MultiLine" Width="462px"></asp:TextBox>
                        <br />
                        <br />
        ...
        <table>
            <tr>
                <td align="center" class="auto-style1">
                    ...
                    &nbsp;&nbsp;<b><asp:Button ID="cmd_SAE" runat="server" CssClass="buttonBox" Height="18px" onclick="cmd_SAE_Click" Text="Imprimir SAE" Width="140px" />
                    </b>&nbsp;&nbsp; <b>
