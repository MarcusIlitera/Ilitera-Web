...
{
    public partial class Relatorio_Vacinas : System.Web.UI.Page
    {
        ...
        protected void btnemp_Click(object sender, EventArgs e)
        {
            ...
            if (chk_AntiHBS.Checked == true) xConsiderar = "1";
            ...
            if (chk_PDF.Checked == true)
            {
                ...
                OpenReport("DadosEmpresa", "RelatorioVacinas.aspx?IliteraSystem=" + strAux.ToString() + strAux.ToString()
                   + "&IdEmpresa=" + Session["Empresa"].ToString() + "&Data1=" + txt_Data.Text + "&Data2=" + txt_Data2.Text + "&xTipo=" + xTipo + "&xEmp=" + xEmp + "&TipoRel=" + xTipoRel + "&xConsiderar=" + xConsiderar + "&NomeCliente=" + Session["NomeEmpresa"].ToString(), "RelatorioVacinas", true);
            }
            else
            {
                string xFile = "Relat_Vacinas_"
                ...
                zDs = xClientes_Funcionarios.Gerar_DS_Relatorio_Vacinas_CSV(
                        System.Convert.ToInt32(Session["Empresa"].ToString()),
                        txt_Data.Text,
                        txt_Data2.Text,
                        xTipoRel,
                        xConsiderar,
                ...
                //string zLinha = "Empregado;Setor;Funcao;Admissao;Nascimento;Afastamento;Retorno;Tipo_Afastamento;Cid1;Cid2;Cid3;Cid4;NumeroCat;Data1;Data2;Registros";
                string zLinha = "Empregado;DataVacina;Vacina;Dose";
            ...
            //Adicionando mucancasd 09/jan/24 1345 Willian
            /*
