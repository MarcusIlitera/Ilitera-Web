...
namespace Ilitera.Net
{
    ...
    public partial class CheckPPRAPeriodos : System.Web.UI.Page
    {
        ...
        private void PopulaAssinados()
        {
            ...
            DataSet zDs = xRep.Retornar_Repositorio_Tipo(System.Convert.ToInt32(Session["Empresa"].ToString()), "'A'"); //, 'X', 'Z'");
