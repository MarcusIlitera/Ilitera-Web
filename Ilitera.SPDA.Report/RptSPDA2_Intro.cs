...
namespace Ilitera.SPDA.Report {
    ...
    public class RptSPDA2_Intro : ReportClass {
        
        public RptSPDA2_Intro() {
        }
        
        public override string ResourceName {
            get {
                return "RptSPDA2_Intro.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.SPDA.Report.RptSPDA2_Intro.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptSPDA2_Intro : Component, ICachedReport {
        
        public CachedRptSPDA2_Intro() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptSPDA2_Intro rpt = new RptSPDA2_Intro();
            rpt.Site = this.Site;
            return rpt;
        }
