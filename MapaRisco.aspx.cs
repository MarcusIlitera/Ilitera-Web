...
namespace Ilitera.Net
{
	...
	/// 
	/// </summary>
	public partial class MapaRisco : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                Response.Redirect(Request["Arquivo"].ToString());
                //RptVasoInspecao report = new DataSourceVasoInspecao(System.Convert.ToInt32( Request["Codigo"].ToString())).GetReport();
