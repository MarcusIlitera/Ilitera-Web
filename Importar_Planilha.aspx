<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Importar_Planilha.aspx.cs"
    Inherits="Ilitera.Net.Importar_Planilha" Title="Ilitera.Net" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent"  >
                    ...
                    <span class="style1">Importar Planilha<br />
    <br /> 
                                    <asp:Label ID="lbl_Selecionar" runat="server" CssClass="boldFont">Selecione planilha para Importação:</asp:Label>
                        <br />
...
&nbsp;&nbsp;
                    <asp:Button ID="cmd_Analisar" runat="server" Text="Analisar Planilha" Font-Size="X-Small" 
                        onclick="cmd_Busca_Click" BackColor="#FF8080" Font-Bold="True" 
                        Width="120px" />
...
<br />
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="cmd_Importar" runat="server" Text="Realizar Importação" Font-Size="X-Small" 
                        onclick="cmd_CSV_Click" BackColor="#FF8080" Font-Bold="True" 
                        Width="120px" Enabled="False" Visible="False" />



&nbsp;&nbsp;
                    <asp:Button ID="cmd_Cancelar" runat="server" Text="Cancelar Processo" Font-Size="X-Small" 
                        onclick="cmd_Cancelar_Processo_Click" BackColor="#FF8080" Font-Bold="True" 
                        Width="120px" Enabled="False" Visible="False" />
...
&nbsp; 
                    ...
                    <asp:Button ID="cmd_Exibir_Log" runat="server" Text="Exibir Log" Font-Size="X-Small" 
                        onclick="cmd_Exibir_Log_Click" BackColor="#FF8080" Font-Bold="True" 
                        Width="120px" Visible="False" />



                    <asp:Label ID="lblLINHA" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_NOME" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_MATRICULA" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_NIT" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
                    <br />
    <asp:Label ID="lblC_CTPS" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_SERIE" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_UF" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_RG" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_CPF" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_SEXO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_NASCIMENTO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_ADMISSAO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_FUNCAO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_CARGO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_SETOR" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_CBO" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
    <asp:Label ID="lblC_CNPJ" runat="server" Font-Size="XX-Small" Visible="False"></asp:Label>
                        ...
                        <br />
                    <asp:ListBox ID="lst_Inconsistencias" runat="server" Font-Names="Arial" Font-Size="8pt" OnSelectedIndexChanged="lst_Inconsistencias_SelectedIndexChanged" Visible="False" Width="690px" Font-Bold="True" ForeColor="#CC0000"></asp:ListBox>
                        ...
                        <br />
                    <asp:ListBox ID="lst_Processamento" runat="server" Font-Names="Arial" Font-Size="8pt" OnSelectedIndexChanged="lst_Inconsistencias_SelectedIndexChanged" Visible="False" Width="690px" Font-Bold="True" ForeColor="#0000CC" Height="118px"></asp:ListBox>
                    <br />


    
                  <asp:GridView ID="grvData" runat="server" OnSelectedIndexChanged="grvData_SelectedIndexChanged">
                    ...
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Font-Bold="False" 
                        ...
                        &nbsp;&nbsp;<asp:Button ID="cmd_Localizar" runat="server" Font-Size="XX-Small" OnClick="cmd_Localizar_Click" Text="Localizar" Visible="False" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;<asp:Button ID="cmd_Linha" runat="server" Font-Size="XX-Small" OnClick="cmd_Linha_Click" Text="Ir para" Visible="False" />
&nbsp;&nbsp;&nbsp;
