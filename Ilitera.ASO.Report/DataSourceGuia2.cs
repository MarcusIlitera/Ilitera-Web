...
{
    public class DataSourceGuia2 : DataSourceBase
    {
        ...
        public DataSourceGuia2(Cliente cliente, int xIdEmpregado, int xIdEmpresa, int xIdClinica, string xExames, string xExames2, string xExames3, string xExames4, string xData_Exame, string xHora_Exame, string xTipo, string xBasico, string xObs2, string xImpDt, int xIdEmpregadoFuncao)
        {
        ...
        public RptGuia_Nova2 GetReport_Nova()
        {
            RptGuia_Nova2 report = new RptGuia_Nova2();
        ...
        public RptGuia_Nova2_Global GetReport_Nova_Global()
        {
            RptGuia_Nova2_Global report = new RptGuia_Nova2_Global();
            report.SetDataSource(GetIntroducaoGuia_Nova());
            //report.OpenSubreport("FotoFachada").SetDataSource(DataSourceFotoFachada());
            report.Refresh();
        ...
        private DataSet GetIntroducaoGuia()
        {
            ...
            {
                newRow["Empregador"] = xCliente.NomeCompleto; //xCliente.GetNomeEmpresa();
            }
            ...
            else
            {
                ...
                newRow["Nascimento"] = "Data Nascimento: " + xEmpregado.hDT_NASC.ToString("dd/MM/yyyy", ptBr); // + xEmpregado.hDT_NASC.Day.ToString() + "/" + xEmpregado.hDT_NASC.Month.ToString() + "/" + xEmpregado.hDT_NASC.Year.ToString();
                newRow["Sexo"] = "Sexo: " + xEmpregado.tSEXO;
                newRow["Admissao"] = "Data Admissão: " + xEmpregado.hDT_ADM.ToString("dd/MM/yyyy", ptBr) + "        " + xCNH; // xEmpregado.hDT_ADM.Day.ToString() + "/" + xEmpregado.hDT_ADM.Month.ToString() + "/" + xEmpregado.hDT_ADM.Year.ToString(); ;
            }
            ...
            if (xCliente.InibirGHE == false)
                newRow["GHE"] = "GHE: " + empregadoFuncao.GetGheEmpregado();
            else
                newRow["GHE"] = "";
        ...
        private DataSet GetIntroducaoGuia_Nova()
        {
            ...
            {
                xExames = xExames.Replace("\n", " , ");
                xExames2 = xExames2.Replace("\n", " , ");
                xExames3 = xExames3.Replace("\n", " , ");
                xExames4 = xExames4.Replace("\n", " , ");
            }
