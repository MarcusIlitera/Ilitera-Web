...
namespace Ilitera.Net
{
	...
	/// 
	/// </summary>
	public partial class PlanilhaPPRA : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                //RptPPRA_A4 report = new DataSourcePlanilhaA4PPRA(Convert.ToInt32(Request["IdLaudoTecnico"])).GetReport();
                ...
                {
                    RptPPRA_A4_Prajna report = new DataSourcePlanilhaA4PPRA(Convert.ToInt32(Request["IdLaudoTecnico"])).GetReport_Prajna();
                ...
                {
                    RptPPRA_A4_Novo report = new DataSourcePlanilhaA4PPRA_Novo(Convert.ToInt32(Request["IdLaudoTecnico"])).GetReport();
                    Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType());
                    CreatePDFDocument(report, this.Response);
                }
                else
