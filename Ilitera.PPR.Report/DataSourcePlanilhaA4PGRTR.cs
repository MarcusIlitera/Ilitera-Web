...
{
	public class DataSourcePlanilhaA4PGRTR : DataSourceBase
	{
		...
		public DataSourcePlanilhaA4PGRTR(Cliente cliente)
		{
		...
		public DataSourcePlanilhaA4PGRTR(LaudoTecnico laudoTecnico)
		{
        ...
        public DataSourcePlanilhaA4PGRTR(LaudoTecnico laudoTecnico, string xListaGHE, Int32 zObra)
        {
            this.laudoTecnico = laudoTecnico;
            this.cliente = laudoTecnico.nID_EMPR;
        ...
        public DataSourcePlanilhaA4PGRTR(Cliente cliente, LaudoTecnico laudoTecnico)
        {
            this.laudoTecnico = laudoTecnico;
            this.cliente = cliente;
            this.ListaGHEs = "";
		...
		public DataSourcePlanilhaA4PGRTR(int IdLaudoTecnico)
		{
		...
		public RptPGRTR_A4 GetReport()
		{
			RptPGRTR_A4 report = new RptPGRTR_A4();
        ...
        public RptPGRTR_A4 GetReport_Consolidado()
        {
            RptPGRTR_A4 report = new RptPGRTR_A4();
        ...
        {
            //xPPRA.nID_TRJ.tDS_TRAJ_RSC
            //xPPRA.nID_MEIO_PRPG.tDS_MEIO_PROP

            StringBuilder str = new StringBuilder();

            if (xPPRA.tDS_FTE_GER != string.Empty)
                str.Append("-" + xPPRA.tDS_FTE_GER.ToLower().Replace(".", "") + "." + System.Environment.NewLine);
            else
            {
                if (xPPRA.nID_RSC.Id == (int)Riscos.RuidoContinuo)
                    str.Append("-Movimentação de máquinas, equipamentos e pessoas." + System.Environment.NewLine);
                else if (xPPRA.nID_RSC.Id == (int)Riscos.Calor)
                    str.Append("-Irradiação solar indireta." + System.Environment.NewLine);
            }

            xPPRA.nID_TRJ.Find();
            if (xPPRA.nID_TRJ.tDS_TRAJ_RSC != string.Empty)
                str.Append("-" + xPPRA.nID_TRJ.tDS_TRAJ_RSC.ToLower().Replace(".", "") + "." + System.Environment.NewLine);

            xPPRA.nID_MEIO_PRPG.Find();
            if (xPPRA.nID_MEIO_PRPG.tDS_MEIO_PROP != string.Empty)
                str.Append("-" + xPPRA.nID_MEIO_PRPG.tDS_MEIO_PROP.ToLower().Replace(".", "") + "." );
