...
namespace Ilitera.PPR.Report {
    ...
    public class RptPGRTR_A4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.PPR.Report.RptPGRTR_A4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptPGRTR_A4 : Component, ICachedReport {
        
        public CachedRptPGRTR_A4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptPGRTR_A4 rpt = new RptPGRTR_A4();
            rpt.Site = this.Site;
            return rpt;
        }
