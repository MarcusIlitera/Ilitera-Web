...
{
	public class DataSourceIntroducaoPGRTR : DataSourceBase
	{
        ...
        public DataSourceIntroducaoPGRTR(Cliente cliente)
		{
		...
		public DataSourceIntroducaoPGRTR(LaudoTecnico laudoTecnico)
		{
        ...
        public DataSourceIntroducaoPGRTR(LaudoTecnico laudoTecnico, string xListaGHE, Int32 xObra, bool xInibir_US)
        {
            this.laudoTecnico = laudoTecnico;
            this.cliente = this.laudoTecnico.nID_EMPR;
        ...
        public DataSourceIntroducaoPGRTR(Cliente cliente, LaudoTecnico laudoTecnico)
        {
            this.laudoTecnico = laudoTecnico;
            this.cliente = cliente;
            this.ListaGHEs = "";
		...
		public DataSourceIntroducaoPGRTR(int IdLaudoTecnico)
		{
        ...
        public RptIntroducaoPGRTR GetReportIndicePGRTR(string zIndice, string zIndice2)
        {
            RptIntroducaoPGRTR report = new RptIntroducaoPGRTR();
            this.zIndice = zIndice;
            this.zIndice2 = zIndice2;
            report.SetDataSource(GetIntroducaoPGRTR());
        ...
        public RptIntroducaoPGRTR_2 GetReportIndicePGRTR_2(string zIndice, string zIndice2)
        {
            RptIntroducaoPGRTR_2 report = new RptIntroducaoPGRTR_2();
            this.zIndice = zIndice;
            this.zIndice2 = zIndice2;
            report.SetDataSource(GetIntroducaoPGRTR_PAE());
            report.Refresh();
        ...
        public RptIntroducaoPGRTR_3 GetReportIndicePGRTR_3(string zIndice, string zIndice2)
        {
            RptIntroducaoPGRTR_3 report = new RptIntroducaoPGRTR_3();
            this.zIndice = zIndice;
            this.zIndice2 = zIndice2;
            report.SetDataSource(GetIntroducaoPGRTR_PAE());
            report.Refresh();
        ...
        private DataSet GetIntroducaoPGRTR()
        {
            ...
            if (Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Prajna") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToString().ToUpper().Trim() == "SIED_NOVO" || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Rophe") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Safety") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToUpper().IndexOf("GLOBAL") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToUpper().IndexOf("VIA") > 0 || Ilitera.Data.SQLServer.EntitySQLServer._LocalServer.ToString().ToUpper().IndexOf("EY") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToUpper().IndexOf("QTECK") > 0)
            {
                ...
                if (rCliente.IdJuridicaPai.Id != 0)
                {
                    ...
                    //sDadosEmpresa = pcmso.IdCliente.GetDadosEmpresaHtml_Obra_Prajna(pcmso.DataPcmso, numTrabExpostos );
                    sDadosEmpresa = rCliente.GetDadosEmpresaHtml_Obra_Prajna(pcmso.DataPcmso, numTrabExpostos, rCliente.InibirDadosMatriz_Laudos);

                    if (rCliente.InibirDadosMatriz_Laudos == true)  //esse campo em branco inibi a página de obra
                        xRazaoSocial_Emp = "";
                    else
                    ...
                    rEnd.Find(" IdPessoa = " + laudoTecnico.nID_EMPR.Id.ToString() + " and  convert( smalldatetime, '" +  laudoTecnico.hDT_LAUDO.ToString("dd/MM/yyyy", ptBr) + "',103 ) between Inicio_Vigencia and Termino_Vigencia ");
            ...
            if (laudoTecnico.nID_EMPR.IdJuridicaPai.Id != 0 && laudoTecnico.nID_EMPR.IdJuridicaPai.Id != laudoTecnico.nID_EMPR.Id)
            {
                newRow["RepresentanteLegal"] = "		A empresa " + laudoTecnico.nID_EMPR.IdJuridicaPai.NomeCompleto + ", unidade de serviço " + laudoTecnico.nID_EMPR.NomeAbreviado + ", CNPJ " + laudoTecnico.nID_EMPR.GetCnpj().ToString() +
                      ...
                      laudoTecnico.nID_EMPR.GetEndereco().Logradouro + " " + laudoTecnico.nID_EMPR.GetEndereco().Numero + " - " + laudoTecnico.nID_EMPR.GetEndereco().GetCidade().ToString() + " / " + laudoTecnico.nID_EMPR.GetEndereco().Uf + ", por seu responsável legal, infra-mencionado, objetivando cumprir e fazer cumprir as normas de segurança do trabalho e em particular a determinação legal exarada através da SEPRT nº 22.677/2020 NR 31 que estabelece a obrigatoriedade da elaboração e implementação pelas empresas do PGRTR PROGRAMA DE GERENCIAMENTO DE RISCOS NO TRABALHO RURAL, resolve nomear equipe de pessoas, que a critério da empresa são capazes de desenvolver o disposto na referida Norma Regulamentadora nº 31, bem como efetuar sempre que necessária e pelo menos uma vez a cada três anos, caso a organização possua certificações do sistema de gestão de SST, uma revisão para aferição de seus resultados e estabelecimento de plano de ação para o novo período. Portando, a responsabilidade técnica do presente documento passa a ser da empresa e dos profissionais abaixo mencionados e firmados.";
        ...
        private DataSet GetIntroducaoPGRTR_PAE()
        {
            DataTable table = new DataTable("Result");
            table.Columns.Add("Base", Type.GetType("System.String"));
            table.Columns.Add("PAE1", Type.GetType("System.String"));
        ...
        private DataSet GetIntroducaoLTCAT()
        {
            DataTable table = new DataTable("Result");
            table.Columns.Add("DadosEmpresa", Type.GetType("System.String"));
            table.Columns.Add("CarimboCNPJ", Type.GetType("System.String"));
            ...
            //if (Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Prajna") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToString().ToUpper().Trim() == "SIED_NOVO" || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Rophe") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Safety") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToUpper().IndexOf("COTIA") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xDB2.ToUpper().IndexOf("VIA") > 0 || Ilitera.Data.SQLServer.EntitySQLServer.xLocalServer.ToString().ToUpper().IndexOf("EY") > 0)
            //{
            //    Cliente rCliente = new Cliente(laudoTecnico.nID_EMPR.Id);
            //    rCliente.IdJuridicaPai.Find();
            ...
            if (Ilitera.Data.SQLServer.EntitySQLServer.xDB2.IndexOf("Prajna") > 0)
            {
                newRow["Data"] = "Elaborado em " + laudoTecnico.hDT_LAUDO.ToString("dd-MM-yyyy");
            }
            else
            {
                if (zData == "")
