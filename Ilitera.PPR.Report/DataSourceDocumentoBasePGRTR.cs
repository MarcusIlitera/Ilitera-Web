...
{
	public class DataSourceDocumentoBasePGRTR : DataSourceBase
	{
		private Cliente cliente;
		private LaudoTecnico laudoTecnico;
        private Int32 zObra;

		public DataSourceDocumentoBasePGRTR(Cliente cliente)
		{
        ...
        public DataSourceDocumentoBasePGRTR(LaudoTecnico laudoTecnico)
        {
		...
		public DataSourceDocumentoBasePGRTR(LaudoTecnico laudoTecnico, Int32 xObra)
		{
			this.laudoTecnico = laudoTecnico;
            this.zObra = xObra;
			this.cliente = laudoTecnico.nID_EMPR;
        ...
        public DataSourceDocumentoBasePGRTR(Cliente cliente, LaudoTecnico laudoTecnico)
        {
            this.laudoTecnico = laudoTecnico;
            this.zObra = 0;
            this.cliente = cliente;
		...
		public DataSourceDocumentoBasePGRTR(int IdLaudoTecnico, Int32  xObra)
		{
		...
		public RptDocumentoBasePGRTR GetReport()
		{
			RptDocumentoBasePGRTR report = new RptDocumentoBasePGRTR();
        ...
        public RptDocumentoBasePGRTR GetReportPGR()
        {
            RptDocumentoBasePGRTR report = new RptDocumentoBasePGRTR();
            report.SetDataSource(GetDataSource());
            report.Refresh();
        ...
        private DataSet GetDataSource()
        {
            ...
            if (cliente.PGR_Personalizado == false)
            {
                ...
                for (int rCont = 0; rCont < rDs.Tables[0].Rows.Count; rCont++)
                {
                    ...
                    if (rDs.Tables[0].Rows[rCont]["AcaoLocalTrab"].ToString() == zOldAcao)
                    {
                        ...
                        newRow["FormaRegistro"] = rDs.Tables[0].Rows[rCont]["FormaReg"].ToString().Replace("PGR", "PGRTR"); 
            ...
            else
            {
                ...
                foreach (CronogramaPGR cronogramaPGR in listCronograma)
                {
                    ...
                    newRow["FormaRegistro"] = cronogramaPGR.FormaReg.Replace("PGR", "PGRTR"); 
