...
namespace Ilitera.Net
{
	...
	///
	/// </summary>
	public partial class PCMSOPlanejamento : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                {
                    RptPCMSOPlanilhaA4_Prajna report = new DataSourcePlanilhaA4PCMSO(pcmso).GetReport_Prajna();
                ...
                else
                {
                    ...
                    if (xTotExames < 20)
                    {
                        RptPCMSOPlanilhaA4 report = new DataSourcePlanilhaA4PCMSO(pcmso).GetReport();
                        Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType());
                        CreatePDFDocument(report, this.Response);
                    }
                    else
