...
namespace Ilitera.Common
{
    public abstract class GZip
    {
        ...
        public static void Compress_bak(string fileName)
        {
            ...
            try
            {
                ...
                string destinationFile = fileName + ".gzip";
                ...
                FileStream fileBuffer = new FileStream(destinationFile, FileMode.Create);

                compressedZipStream = new GZipStream(fileBuffer, CompressionMode.Compress, true);
        ...
        #region  Descompress_bak

        public static void Descompress_bak()
        {
            FileStream inputFile = null;
            GZipStream compressedZipStream = null;
            ...
            try
            {
                ...
                inputFile = new FileStream("c:\\mylogcompressed.txt", FileMode.Open, FileAccess.Read, FileShare.Read);
        ...
        #region inner class GZippedFile
