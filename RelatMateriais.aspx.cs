...
namespace Ilitera.Net
{
	...
	/// 
	/// </summary>
	public partial class RelatMateriais: System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                Ilitera.Sied.Report.RptReciboMateriais report;

                Ilitera.Opsa.Data.Empregado rEmpregado = new Ilitera.Opsa.Data.Empregado(System.Convert.ToInt32(Request["IdEmpregado"]));

                report = new Ilitera.Sied.Report.ListaEntregaEPI(rEmpregado, 0).GetReportEntregaMateriais(Request["Material"]);
