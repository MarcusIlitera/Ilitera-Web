...
namespace Ilitera.Net
{
	...
	/// 
	/// </summary>
	public partial class Insalubridade : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                //report = new DataSourceInsalubridade(empregadoFuncao, laudoTecnico, (int)IndTipoPPRA.PPRA).GetReport();
                if (Request["Tipo"].ToString().Trim() == "1")
                   report = new DataSourceInsalubridade(alEmpregados, (int)IndTipoPPRA.PPRA).GetReport();
                else
                   report = new DataSourceInsalubridade(alEmpregados, (int)IndTipoPPRA.LTCAT).GetReport();
