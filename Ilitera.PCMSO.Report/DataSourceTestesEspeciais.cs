...
{
    public class DataSourceTestesEspeciais : DataSourceBase
    {
        #region Eventos
        ...
        public DataSourceTestesEspeciais(Int32 zIdExameBase, bool zSemResposta)
        {
            InicializarTables();
            ...
            EmpregadoFuncao empregadoFuncao = EmpregadoFuncao.GetEmpregadoFuncao(this.clinico.IdEmpregado);
        ...
        public DataSourceTestesEspeciais(Clinico clinico)
        {
            InicializarTables();
        ...
        public DataSourceTestesEspeciais(   ConvocacaoExame convocacao,   
                                        Pcmso pcmso, 
        ...
        public RptTestesEspeciais GetReport()
        {
            RptTestesEspeciais report = new RptTestesEspeciais();
        ...
        private void DataSourceAso(Clinico clinico)
        {
            ...
            Ilitera.Data.Clientes_Clinicas zQuest = new Ilitera.Data.Clientes_Clinicas();

            DataSet ds = zQuest.Trazer_Clinico_Testes_Especiais(clinico.Id.ToString());
            ...
            for ( int zCont=0; zCont<ds.Tables[0].Rows.Count;zCont++)
            {
                ...
                if (zSistema != ds.Tables[0].Rows[zCont][1].ToString().Trim())
                {
                    zSistema = ds.Tables[0].Rows[zCont][1].ToString().Trim();
                    newRow2["Sistema"] = ds.Tables[0].Rows[zCont][1].ToString().Trim();
                }
                else
                {
                    newRow2["Sistema"] = "";
                ...
                newRow2["Questao"] = ds.Tables[0].Rows[zCont][2].ToString().Trim();
                ...
                {
                    if (ds.Tables[0].Rows[zCont][3].ToString().Trim().Substring(0, 1) == "S")
                    {
                        newRow2["tX_APTO"] = "X";
                        newRow2["tX_INAPTO"] = "";
                    }
        ...
        private class PopularRow
        {
            ...
            public void ExameEmpregado(Clinico clinico)
            {
                ...
                {   
                    newRow["dDT_EXAME"] = clinico.IdEmpregadoFuncao.nID_EMPR.GetMunicipio() + " , " + clinico.DataExame.ToString("dd-MM-yyyy") + ".";
                }
