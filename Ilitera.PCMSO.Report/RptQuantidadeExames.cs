...
namespace Ilitera.PCMSO.Report {
    ...
    public class RptQuantidadeExames : ReportClass {
        
        public RptQuantidadeExames() {
        }
        
        public override string ResourceName {
            get {
                return "RptQuantidadeExames.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.PCMSO.Report.RptQuantidadeExames.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptQuantidadeExames : Component, ICachedReport {
        
        public CachedRptQuantidadeExames() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptQuantidadeExames rpt = new RptQuantidadeExames();
            rpt.Site = this.Site;
            return rpt;
        }
