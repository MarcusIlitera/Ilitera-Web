<%@ Page Title="Ilitera.Net" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True"    CodeBehind="CheckPCAPeriodos.aspx.cs" Inherits="Ilitera.Net.CheckPCAPeriodos" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent" >
    <div class="container-fluid d-flex ms-5 ps-4">
        ...
        <div class="col-11 subtituloBG mb-3" style="padding-top: 10px;">
            <asp:Label ID="lblPPRA" runat="server" SkinID="TitleFont" CssClass="subtitulo">PCA / PPR</asp:Label>
        </div>


    <div class="col-11 text-center">

      <div class="row d-flex justify-content-center me-8">
         <div class="col-3 mb-3 text-center">
               <asp:dropdownlist ID="ddlLaudos2" onselectionchanged="ddlLaudos2_SelectionChanged"  runat="server" CssClass="texto form-select form-select-sm" style="align-content:center" AutoPostBack="True"></asp:dropdownlist>
           </div>
            </div>

        <div class="row">
       <div class="col-12 mb-3 gx-2 gy-4 text-center">
              <asp:Button ID="btnPCA" OnClick="lkbPCA_Click"  runat="server" Width="240px" CssClass="btn" Text="PCA" Font-Size="8pt" />
              <asp:Button ID="btnPPR" OnClick="lkbPPR_Click" runat="server" Width="240px" CssClass="btn" Text="PPR" Font-Size="8pt" />
              <asp:Button ID="btnTeste" runat="server"  Width="240px" CssClass="btn" Text="PPR" Visible="False" Font-Size="8pt" />
       </div>
         </div>
    ...
    <div class="row">
       <div class="container-fluid d-flex justify-content-center text-center gx-3 gy-2">
                                                    <eo:Grid ID="grd_Clinicos" runat="server" ClientSideOnItemCommand="OnItemCommand" ColumnHeaderAscImage="00050403" 
                                                        ...
                                                        FixedColumnCount="1"  OnItemCommand="grd_Clinicos_ItemCommand"
                                                        GridLines="Both" Height="227px" ItemHeight="30" 
                                                        KeyField="IdRepositorio" Width="640px">
                                                     <ItemStyles> 
                                                          <eo:GridItemStyleSet>                    
