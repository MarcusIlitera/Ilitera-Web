...
{
    public partial class Controle_eSocial_2230 : System.Web.UI.Page
    {
        ...
        private void Carga_Grid()
        {
            ...
            zDs = xLista.Mensageria_2230(Convert.ToInt32(Request.QueryString["IdEmpresa"]), 0, 0, txt_Data.Text, txt_Data2.Text, xUser.IdUsuario, zTipo_Carga, txt_Nome.Text, zGrupo, cliente.ESocial_Ambiente);
        ...
        protected void cmd_Criar_Click(object sender, EventArgs e)
        {
            ...
            foreach (EO.Web.GridItem item in grd_eSocial.CheckedItems)
            {
                ...
                string xIdAfastamento = item.Cells[11].Value.ToString();
                ...
                Processar_S2230(System.Convert.ToInt32(xIdAfastamento), xD1, xD2, zCod, user.IdUsuario, zContador);
        ...
        public void Processar_S2230(Int32 zIdAfastamento, string zD1, string zD2, string zCod, Int32 zIdUsuario, int zContador)
        {
            ...
            DataSet rDs = zEsocial.Trazer_2230(zIdAfastamento);
            ...
            for (int zCont = 0; zCont < rDs.Tables[0].Rows.Count; zCont++)
            {
                ...
                try
                {
                    ...
                    if (xIniAfastamento.codMotAfast == "01" || xIniAfastamento.codMotAfast == "03")
                    {
                        ...
                        int zOcorrencia = xMesmo.Trazer_Afastamento_Anterior_CID(zIdAfastamento, rDs.Tables[0].Rows[zCont]["DtInicial"].ToString().Trim(), xCID);
                    ...
                    if (xArq.Trim() == "")
                    {
                        xArq = "I:\\temp\\Evt2230_" + System.DateTime.Now.Second.ToString().Trim() + System.DateTime.Now.Minute.ToString().Trim() + System.DateTime.Now.Millisecond.ToString().Trim() + System.DateTime.Now.Day.ToString().Trim() + System.DateTime.Now.Month.ToString().Trim() + ".xml";
                    }
                    ...
                    if (zCod == "")
                    {
                        zeSocial.XML_Deposito(xArq, xeSocial.Id, zCont, xContent, rDs.Tables[0].Rows[zCont]["CPF"].ToString(), zPis, rDs.Tables[0].Rows[zCont]["CNPJ"].ToString(), zD1, zD2, System.Convert.ToInt32(rDs.Tables[0].Rows[0]["IdAfastamento"].ToString()), xAfast.Id,0);
                    }
                    else
                    {
                        zeSocial.XML_Deposito(zCod, xArq, xeSocial.Id, zCont, xContent, rDs.Tables[0].Rows[zCont]["CPF"].ToString(), zPis, rDs.Tables[0].Rows[zCont]["CNPJ"].ToString(), zD1, zD2, System.Convert.ToInt32(rDs.Tables[0].Rows[0]["IdAfastamento"].ToString()), xAfast.Id,0);
        ...
        protected void cmd_Enviar_Click(object sender, EventArgs e)
        {
            ...
            //        xAssinado = assinarXML(xDoc, cert, "evtAfastTemp", "Id");
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            foreach (EO.Web.GridItem item in grd_eSocial.CheckedItems)
            {
                ...
                string xArq = "I:\\temp\\2230_" + zCont.ToString().Trim() + "_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + "_" + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString() + ".XML";
