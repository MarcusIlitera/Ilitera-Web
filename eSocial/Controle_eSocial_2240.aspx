<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="Controle_eSocial_2240.aspx.cs"  Inherits="Ilitera.Net.e_Social.Controle_eSocial_2240" Title="Ilitera.Net" %>
    ...
    <script language="javascript">
        ...
        function OnItemCommand(grid, itemIndex, colIndex, commandName) {
            ...
            <div class="col-11 subtituloBG" style="padding-top: 10px;">
                <asp:label id="lblExCli" runat="server" SkinID="TitleFont" CssClass="subtitulo">Evento 2240 eSocial</asp:label>
            </div>
   ...
   <div class="col-11" style="margin-left: 5rem; padding-left:30px;">
        <eo:Grid ID="grd_eSocial" runat="server" ColumnHeaderAscImage="00050403" 
                ...
                <eo:StaticColumn HeaderText="Empresa" AllowSort="False" 
                    ...
                    SortOrder="Ascending" Text="" Width="125">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="Colaborador" AllowSort="False" 
                    DataField="Colaborador" Name="Colaborador" ReadOnly="True" 
                    SortOrder="Ascending" Text="" Width="160">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="CPF" AllowSort="False" 
                    DataField="CPF" Name="CPF" ReadOnly="True" Width="80">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="Demissao" AllowSort="False" 
                    DataField="Demissao" Name="Demissao" ReadOnly="True" 
                    Width="70">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>
                ...
                <eo:StaticColumn HeaderText="Fim Condicao" AllowSort="False" 
                    DataField="DtFimCondicao" Name="DtFimCondicao" ReadOnly="True"  
                    Width="70">
                   <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="GHE" AllowSort="False" 
                    DataField="GHE" Name="GHE" ReadOnly="True"  
                    Width="70">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>
                ...
                <eo:StaticColumn HeaderText="nId_Func_Empregado" AllowSort="False" 
                    DataField="nId_Func_Empregado" Name="nId_Func_Empregado" ReadOnly="True"  
                    Width="0">
                    <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                </eo:StaticColumn>
        ...
        <div class="col-11 ms-5 ps-3 mb-2">
            <div class="row">
                <div class="col-1 gx-3 gy-2">
                    <asp:ListBox ID="lst_Detalhes" OnSelectedIndexChanged="lst_Detalhes_SelectedIndexChanged" runat="server" Height="105px" Visible="False" Width="664px" Font-Size="Small" AutoPostBack="True" BackColor="#FFFFCC" Font-Names="Courier New"></asp:ListBox>
                ...
                <div class="col-5 gx-3 gy-2 text-start mb-3 ms-5 ps-4">
                    <asp:Button ID="cmd_Fechar_Det" runat="server" CssClass="btn" Text="Fechar Detalhes" OnClick="cmd_Fechar_Det_Click" Visible="False" />
                    ...
                    <asp:Button ID="cmd_Proc_Atualizar" runat="server" CssClass="btn" Text="Atualizar Status Processamento" OnClick="cmd_Proc_Proc_Atualizar_Click" Enabled="False" Visible="False" />
                </div>
