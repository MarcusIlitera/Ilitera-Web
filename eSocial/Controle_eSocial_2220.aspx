<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="Controle_eSocial_2220.aspx.cs"  Inherits="Ilitera.Net.e_Social.Controle_eSocial_2220" Title="Ilitera.Net" %>
    ...
    <script language="javascript">
        ...
        function OnItemCommand(grid, itemIndex, colIndex, commandName) {
            ...
            <div class="col-11 subtituloBG" style="padding-top: 10px;">
                <asp:label id="lblExCli" runat="server" SkinID="TitleFont" CssClass="subtitulo">Evento 2220 eSocial</asp:label>
            </div>
                ...
                <div class="row">
                   ...
                   <div class="col-11" style="margin-left: 5rem; padding-left:30px;">
                        <eo:Grid ID="grd_eSocial" runat="server" ColumnHeaderAscImage="00050403" 
                            ...
                            Font-Overline="False" Font-Size="8pt" Font-Strikeout="False"  Font-Underline="False" GridLineColor="240, 240, 240" 
                        ...
                        <Columns>
                            ...
                            <eo:StaticColumn HeaderText="Colaborador" AllowSort="False" 
                                ...
                                SortOrder="Ascending" Text="" Width="170">
                                <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                            </eo:StaticColumn>
                            ...
                            <eo:StaticColumn HeaderText="Exame" AllowSort="False" 
                                DataField="Exame" Name="Exame" ReadOnly="True" 
                                Width="120">
                               <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; color: #7D7B7B; text-align:left;" />
                            </eo:StaticColumn>

                            <eo:StaticColumn HeaderText="Data Exame" AllowSort="False" 
                            ...
                            <eo:StaticColumn HeaderText="IdExameBase" AllowSort="False" 
