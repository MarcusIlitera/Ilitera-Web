<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="Controle_eSocial_2230.aspx.cs"  Inherits="Ilitera.Net.e_Social.Controle_eSocial_2230" Title="Ilitera.Net" %>
...
<TABLE class="defaultFont" cellSpacing="0" cellPadding="0" width="900" align="center" border="0" bgcolor="white">
				<TR>
					<TD class="defaultFont" align="center" colSpan="1"><asp:label id="lblExCli" 
                            runat="server" SkinID="TitleFont" style="font-weight: 700">Evento 2230 eSocial</asp:label><BR>
						<BR>
					</TD>
                    </TR>
    <TR>
					<TD>
                        <asp:label id="Label1" 
                            ...
                            <asp:ListItem Value="4">Enviados</asp:ListItem>                        </asp:DropDownList>
    ...
    <tr>
        <td>
            ...
            &nbsp;
            <asp:Button ID="cmd_Enviar" runat="server" Font-Size="X-Small" Text="Enviar/Reenviar" Width="90px" OnClick="cmd_Enviar_Click" Enabled="False" Visible="False" />
            &nbsp;
            <asp:Button ID="cmd_Baixar" runat="server" Font-Size="X-Small" Text="Baixar XML" Width="75px" OnClick="Button3_Click" />
        &nbsp;&nbsp;
            <asp:Button ID="cmd_Agendar_Envio" runat="server" Font-Size="X-Small" Text="Agendar Envio" Width="90px" OnClick="cmd_Agendar_Envio_Click" />
        </td>
        ...
        ClientSideOnItemCommand="OnItemCommand"  >
            ...
            <Columns>
                ...
                <eo:StaticColumn HeaderText="PIS" AllowSort="False" 
                    DataField="PIS" Name="PIS" ReadOnly="True" 
                    Width="0">
                    <CellStyle CssText="text-align:center; font-size: xx-small;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="Data Afast." AllowSort="False" 
                    DataField="DtIniCondicao" Name="DtIniCondicao" ReadOnly="True"  
                    Width="70">
                    <CellStyle CssText="text-align:center; font-size: xx-small;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="Fim Condicao" AllowSort="False" Visible="false"
                ...
                <eo:StaticColumn HeaderText="IdAfastamento" AllowSort="False" 
                    DataField="IdAfastamento" Name="IdAfastamento" ReadOnly="True"  
                    Width="0">
                    <CellStyle CssText="text-align:center; font-size: xx-small;" />
                </eo:StaticColumn>
