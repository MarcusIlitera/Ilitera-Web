                ...
                try
                {
                    ...
                    for (int zAux = 0; zAux < rExames.Length; zAux++)
                    {
                        ...
                        else
                        {
                            ...
                            //data compl.não pode ser após data ASO
                            if (xD1 > xD2)
                            {
                                zExames = zExames - 1;
                            }
                            ...
                            {
                                //se não for admissional, data exame nao pode ser anterior à admissão
                    ...
                    if (xTipoExame.tpExameOcup != 9)   //demissional não fazer essa busca de exames
                    {
                            ...
                            if (xD1 <= xD2)
                            {
                                ...
                                if (rDs.Tables[0].Rows[zCont]["TpASO"].ToString().Trim() == "0" || (rDs.Tables[0].Rows[zCont]["TpASO"].ToString().Trim() != "0" && xD1 >= xD3))
                                {
                                    ...
                                    if (rFind == false)
                                    {
                                        ...
                                        //checar se em Opsa->PCMSOGHE.RiscosOcupacionais há flag <esocial>,
                    ...
                    //remover algum exame com código eSocial repetido
                    string rCods = "";
