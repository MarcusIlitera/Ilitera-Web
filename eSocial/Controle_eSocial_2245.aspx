<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="Controle_eSocial_2245.aspx.cs"  Inherits="Ilitera.Net.e_Social.Controle_eSocial_2245" Title="Ilitera.Net" %>
...
<TABLE class="defaultFont" cellSpacing="0" cellPadding="0" width="900" align="center" border="0" bgcolor="white">
				<TR>
					<TD class="defaultFont" align="center" colSpan="1"><asp:label id="lblExCli" 
                            runat="server" SkinID="TitleFont" style="font-weight: 700">Evento 2245 eSocial</asp:label><BR>
						<BR>
					</TD>
                    </TR>
    <TR>
    ...
    <tr>
        ...
        ClientSideOnItemCommand="OnItemCommand"  >
            ...
            <Columns>
                ...
                <eo:StaticColumn HeaderText="Treinamento" AllowSort="False" 
                    DataField="Treinamento" Name="Treinamento" ReadOnly="True" 
                    Width="180">
                    <CellStyle CssText="text-align:center; font-size: xx-small;" />
                </eo:StaticColumn>

                <eo:StaticColumn HeaderText="Data" AllowSort="False" 
                ...
                <eo:StaticColumn HeaderText="IdParticipanteTreinamento" AllowSort="False" 
                    DataField="IdParticipanteTreinamento" Name="IdParticipanteTreinamento" ReadOnly="True"  
                    Width="0">
                    <CellStyle CssText="text-align:center; font-size: xx-small;" />
                </eo:StaticColumn>
