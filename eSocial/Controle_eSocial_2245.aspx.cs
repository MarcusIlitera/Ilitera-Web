...
{
    public partial class Controle_eSocial_2245 : System.Web.UI.Page
    {
        ...
        private void Carga_Grid()
        {
            ...
            zDs = xLista.Mensageria_2245(Convert.ToInt32(Request.QueryString["IdEmpresa"]), 0, 0, txt_Data.Text, txt_Data2.Text, xUser.IdUsuario, zTipo_Carga, txt_Nome.Text, zGrupo);
        ...
        protected void cmd_Criar_Click(object sender, EventArgs e)
        {
            ...
            cmd_Criar.Enabled = false;
            cmd_Filtrar.Enabled = false;
            ...
            foreach (EO.Web.GridItem item in grd_eSocial.CheckedItems)
            {
                ...
                string xIdParticipanteTreinamento = item.Cells[11].Value.ToString();
                ...
                Processar_S2245(System.Convert.ToInt32(xIdParticipanteTreinamento), xD1, xD2, zCod, user.IdUsuario);
            ...
            cmd_Criar.Enabled = true;
            cmd_Filtrar.Enabled = true;
        ...
        public void Processar_S2245(Int32 zIdParticipanteTreinamento, string zD1, string zD2, string zCod, Int32 zIdUsuario)
        {
            ...
            DataSet rDs = zEsocial.Trazer_2245( zIdParticipanteTreinamento);
            ...
            //        if ( rDs.Tables[0].Rows[zCont]["CodTreiCap"].ToString().Trim().Length == 3 )
            //           xTreiCap.codTreiCap = "0" + rDs.Tables[0].Rows[zCont]["CodTreiCap"].ToString().Trim();
            //        else
            //           xTreiCap.codTreiCap = rDs.Tables[0].Rows[zCont]["CodTreiCap"].ToString().Trim();
            ...
            //        // xCat.cat = xEvtCat;
                    ...
                    if (xArq.Trim() == "")
                    {
                        xArq = "I:\\temp\\Evt2245_" + System.DateTime.Now.Second.ToString().Trim() + System.DateTime.Now.Minute.ToString().Trim() + System.DateTime.Now.Millisecond.ToString().Trim() + System.DateTime.Now.Day.ToString().Trim() + System.DateTime.Now.Month.ToString().Trim() + ".xml";
                    }
                    ...
                    //if (zCod == "")
                    //{
                    //    zeSocial.XML_Deposito(xArq, xeSocial.Id, zCont, xContent, rDs.Tables[0].Rows[zCont]["CPF"].ToString(), zPis, rDs.Tables[0].Rows[zCont]["CNPJ"].ToString(), zD1, zD2, System.Convert.ToInt32(rDs.Tables[0].Rows[0]["IdParticipanteTreinamento"].ToString()), xTrei.Id);
                    //}
                    //else
                    //{
                    //    zeSocial.XML_Deposito(zCod, xArq, xeSocial.Id, zCont, xContent, rDs.Tables[0].Rows[zCont]["CPF"].ToString(), zPis, rDs.Tables[0].Rows[zCont]["CNPJ"].ToString(), zD1, zD2, System.Convert.ToInt32(rDs.Tables[0].Rows[0]["IdParticipanteTreinamento"].ToString()), xTrei.Id);
        ...
        protected void cmd_Enviar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (EO.Web.GridItem item in grd_eSocial.CheckedItems)
                {
                    ...
                    xAssinado = assinarXML(xDoc, cert, "evtTreiCap", "Id");
        ...
        protected void cmd_Baixar_Click(object sender, EventArgs e)
        {
            ...
            foreach (EO.Web.GridItem item in grd_eSocial.CheckedItems)
            {
                ...
                string xArq = "I:\\temp\\2245_" + zCont.ToString().Trim() + "_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + "_" + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString() + ".XML";
