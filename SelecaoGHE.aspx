         ...
         <div class="col-11 mb-3">
             <div class="row">
                 <div class="col-md-2 gx-3 gy-2">
                     <asp:Label ID="Label1" runat="server" Text="Selecione PGR" CssClass="tituloLabel form-label"></asp:Label>
                     <asp:ListBox ID="lst_PPRA" runat="server" Height="106px" AutoPostBack="True" CssClass="texto form-control" onselectedindexchanged="lst_PPRA_SelectedIndexChanged"></asp:ListBox>
                     <div class="ms-4 mt-2">
                         <asp:CheckBox ID="chk_Finalizado" runat="server" AutoPostBack="True" Text="Somente Finalizados" CssClass="texto form-check-input bg-transparent border-0" OnCheckedChanged="chk_Finalizado_CheckedChanged" />
                     </div>
                 </div>
                 ...
                 <div class="col-10">
                     <div class="row">
                         <div class="col-12 gx-3 gy-2">
                             <asp:Label ID="lbl_Selecao" runat="server" Text="Lista de GHE do PGR Selecionado" CssClass="tituloLabel form-label"></asp:Label>
                             <asp:DropDownList ID="cmb_GHE" runat="server" AutoPostBack="True" CssClass="texto form-select" onselectedindexchanged="cmb_GHE_SelectedIndexChanged"></asp:DropDownList>
                         </div>
                 ...
                 <div class="col-12">
                     <div class="row">
                         <div class="col-4 gx-3 gy-2 mb-2">
                             <asp:Label ID="lbl_Selecao1" runat="server" Text="Colaboradores sem GHE para esse PGR" CssClass="tituloLabel form-label"></asp:Label>
                         </div>
                         <div class="col-4 gx-3 gy-2 mb-2">
                             <asp:CheckBox ID="chk_Demitidos" runat="server" AutoPostBack="True" Text="Visualizar demitidos" CssClass="texto form-check-input bg-transparent border-0" oncheckedchanged="chk_Demitidos_CheckedChanged" />
                         </div>
                         ...
                         <div class="col-12 mb-3">
                                        <eo:Grid ID="gridEmpregadossemGHE" runat="server" ColumnHeaderAscImage="00050403" 
                                            ColumnHeaderDescImage="00050404" FixedColumnCount="1" 
                                            GridLines="Both" Height="145px" Width="1050px" ColumnHeaderDividerOffset="6" 
                                            ColumnHeaderHeight="30" ItemHeight="30" KeyField="nId_Empregado_Funcao" CssClass="grid" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" OnItemCommand="gridEmpregadossemGHE_ItemCommand">
                                        <ItemStyles>
                                            <eo:GridItemStyleSet>
                                        ...
                                        <Columns>
                                            ...
                                            <eo:StaticColumn HeaderText="Dt.Início" AllowSort="True" 
                                                ...
                                                SortOrder="Ascending" Text="" Width="85">
                                                <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; font-weight: 500; color: #B0ABAB !important; text-align: left; height: 35px !important; padding: 0.3rem 0.3rem 0.3rem 0.5rem; height: 35px !important;" />
                                            </eo:StaticColumn>
                         ...
                         <div class="col-12 mb-3">
                             <div class="row justify-content-center">
                                 <div class="col-2">
                                     <asp:Button ID="cmd_Add_1" runat="server" CssClass="btn" Text="Adicionar no GHE" width="130px" onclick="cmd_Add_1_Click" />
                                 </div>

                                 <div class="col-2">
                                    <asp:Button ID="cmd_Remove_1" runat="server" CssClass="btn" Text="Remover do GHE" Width="130px" onclick="cmd_Remove_1_Click" />
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-12 mb-3">
                                        <eo:Grid ID="gridEmpregados" runat="server" ColumnHeaderAscImage="00050403" ColumnHeaderDescImage="00050404" FixedColumnCount="1" 
                                            GridLines="Both" Height="145px" Width="1050px" ColumnHeaderDividerOffset="6" 
                                            ColumnHeaderHeight="30" ItemHeight="30" KeyField="nId_Empregado_Funcao" CssClass="grid">
                                        <ItemStyles>
                                            <eo:GridItemStyleSet>
                                                <ItemStyle CssText="background-color: white" />
                                                <AlternatingItemStyle CssText="background-color:#eeeeee;" />
