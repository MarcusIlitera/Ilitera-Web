...
namespace Ilitera.Net.DadosEmpresa
{
	...
	/// 
	/// </summary>
    public partial class RelatorioVacinas : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                xEmp = Request["xEmp"].ToString().Trim();


                if (xTipoRel == "C")
                {
                    rptVacinas_Atrasadas report = new DataSourceVacinas().GetReport_Convocacao(System.Convert.ToInt32(xId_Empresa),  xNomeCliente, System.Convert.ToInt16(xEmp), xConsiderar);
                ...
                {
                    rptVacinas_Analitico report = new DataSourceVacinas().GetReport_Bloqueio(System.Convert.ToInt32(xId_Empresa), xData1, xData2, xNomeCliente, System.Convert.ToInt16(xEmp), xConsiderar);
                    Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType());
                    CreatePDFDocument(report, this.Response);
                }
                else
                {
                    rptVacinas_Sumarizado report = new DataSourceVacinas().GetReport_Bloqueio_Sum(System.Convert.ToInt32(xId_Empresa), xData1, xData2, xNomeCliente, System.Convert.ToInt16(xEmp), xConsiderar);
                    Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType());
                    CreatePDFDocument(report, this.Response);
                }              
			}
