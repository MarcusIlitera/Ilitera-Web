...
namespace Ilitera.Net.DadosEmpresa
{
	...
	/// 
	/// </summary>
    public partial class RelatorioAmbulatoriais : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                if (xTipoRel == "A")
                {
                    rptAmbulatoriais_Analitico report = new DataSourceAmbulatoriais().GetReport_Bloqueio(System.Convert.ToInt32(xId_Empresa), xData1, xData2, xNomeCliente, System.Convert.ToInt16(xEmp), xConsiderar);
                ...
                {
                    rptAmbulatoriais_Sumarizado report = new DataSourceAmbulatoriais().GetReport_Bloqueio_Sum(System.Convert.ToInt32(xId_Empresa), xData1, xData2, xNomeCliente, System.Convert.ToInt16(xEmp), xConsiderar);
                    Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType());
                    CreatePDFDocument(report, this.Response);
                }              
			}
