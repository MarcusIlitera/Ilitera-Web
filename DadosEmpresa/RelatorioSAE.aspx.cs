...
namespace Ilitera.Net.DadosEmpresa
{
	...
	/// 
	/// </summary>
	public partial class RelatorioSAE : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                xIdExame = Request["IdExame"].ToString().Trim();

                string xUsuario = Session["usuarioLogado"].ToString();


                ExameFisicoAmbulatorial zExame = new ExameFisicoAmbulatorial(System.Convert.ToInt32(xIdExame));

                rptSAE report = new DataSourceSAE(zExame).GetReport();
