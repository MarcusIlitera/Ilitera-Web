...
{
	public class DataSourcePlanilhaA4PPRA_PPR : DataSourceBase
	{
		private Cliente cliente;
		private LaudoTecnico laudoTecnico;
		public bool ComGheSemEmpregado=false;
		
		public DataSourcePlanilhaA4PPRA_PPR(Cliente cliente)
		{
		...
		public DataSourcePlanilhaA4PPRA_PPR(LaudoTecnico laudoTecnico)
		{
        ...
        public DataSourcePlanilhaA4PPRA_PPR(Cliente cliente, LaudoTecnico laudoTecnico)
        {
            this.laudoTecnico = laudoTecnico;
            this.cliente = cliente;
        ...
        public DataSourcePlanilhaA4PPRA_PPR(int IdLaudoTecnico)
		{
		...
		public RptPPRA_A4_PPR GetReport()
		{
			RptPPRA_A4_PPR report = new RptPPRA_A4_PPR();
        ...
        private DataSet GetDataSource()
        {
            ...
            foreach (Ghe ghe in listGhe)
            {
                ...
                foreach (PPRA ppra in listPPRA)
                {
                    ...
                    xRsc = ppra.nID_RSC.ToString();


                    //wagner
                    //trocar estas checagens por qualquer risco com qualquer EPI do tipo respiratório
                    //



                    //if (xRsc.IndexOf("Anexo 13") >= 0 || xRsc.IndexOf("Anexo 12") >= 0 || xRsc.IndexOf("Anexo 11") >= 0)
                    //{
                    //if (System.Convert.ToSingle(xConcentracao.Substring(0, xConcentracao.IndexOf(" "))) >= 80)
                    //{
