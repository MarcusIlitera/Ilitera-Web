...
namespace Ilitera.Sied.Report {
    ...
    public class RptPPRA_A4_PCA : ReportClass {
        
        public RptPPRA_A4_PCA() {
        }
        
        public override string ResourceName {
            get {
                return "RptPPRA_A4_PCA.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.Sied.Report.RptPPRA_A4_PCA.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptPPRA_A4_PCA : Component, ICachedReport {
        
        public CachedRptPPRA_A4_PCA() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptPPRA_A4_PCA rpt = new RptPPRA_A4_PCA();
            rpt.Site = this.Site;
            return rpt;
        }
