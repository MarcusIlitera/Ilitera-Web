...
namespace Ilitera.Sied.Report {
    ...
    public class ReportPPP99_Global : ReportClass {
        
        public ReportPPP99_Global() {
        }
        
        public override string ResourceName {
            get {
                return "ReportPPP99_Global.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.Sied.Report.ReportPPP99_Global.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReportPPP99_Global : Component, ICachedReport {
        
        public CachedReportPPP99_Global() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReportPPP99_Global rpt = new ReportPPP99_Global();
            rpt.Site = this.Site;
            return rpt;
        }
