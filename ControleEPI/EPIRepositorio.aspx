<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="CipaRepositorio.aspx.cs"  Inherits="Ilitera.Net.EPIRepositorio" Title="Ilitera.Net" %>
...
--%>
    <div class="col-11 subtituloBG"  style="padding-top: 10px">
        <asp:Label id="Label1" runat="server" CssClass="subtitulo">Repositório EPI</asp:Label>
		<asp:panel id="Panel2" runat="server" Width="662px"></asp:panel>
	</div>
    <div class="col-11  mb-2">
		<div class="row gx-2 gy-2">
            <div class="col-md-2 ms-3 me-3">
                <asp:label id="lblNome" runat="server" CssClass="tituloLabel mb-2">Selecione Colaborador:&nbsp;</asp:label>
                <asp:dropdownlist id="ddlEmpregado" onselectedindexchanged="ddlEmpregado_SelectedIndexChanged"  runat="server" CssClass="texto form-select form-select-sm" AutoPostBack="True"></asp:dropdownlist>
            </div>
        </div>
	</div>
            <caption>
                <input id="txtIdUsuario" type="text" visible="False" CssClass="texto form-control" style="visibility:hidden"  />
                <input id="txtIdEmpregado" type="text" visible="False" CssClass="texto form-control" style="visibility:hidden" />
                <input id="txtIdEmpresa" type="text" visible="False" CssClass="texto form-control" style="visibility:hidden"/>
            </caption>
     ...
     <eo:TabStrip ID="TabStrip1" runat="server" ControlSkinID="None" 
            ...
            <topgroup>
                <Items>
                    <eo:TabItem Text-Html="Fichas Digitalizadas">
                    </eo:TabItem>
                </Items>
            </topgroup>
            <lookitems>
        ...
        <eo:MultiPage ID="MultiPage1" runat="server" Height="200" Width="1050">
            ...
            <eo:PageView ID="Pageview2" runat="server">
                ...
                <eo:Grid ID="grd_Clinicos" runat="server" 
                    ...
                    FixedColumnCount="1" GridLines="Both" Height="149px" ItemHeight="30"  OnItemCommand="grd_Clinicos_ItemCommand" 
                    KeyField="IdEPIRepositorio" Width="851px">
                    <itemstyles>
                        <eo:GridItemStyleSet>
                    ...
                    <Columns>
                        <eo:StaticColumn AllowSort="True" DataField="DataHora" HeaderText="Data da Ficha" Name="DataHora" ReadOnly="True" SortOrder="Ascending" Text="" Width="125">
                            <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; font-weight: 500; color: #7D7B7B !important; text-align: left; height: 35px !important; padding: 0.3rem 0.3rem 0.3rem 0.5rem; height: 35px !important;" />
                        </eo:StaticColumn>
                        <eo:StaticColumn AllowSort="True" DataField="Descricao" HeaderText="Descrição" Name="Descricao" ReadOnly="True" Width="440">
                            <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; font-weight: 500; color: #7D7B7B !important; text-align: left; height: 35px !important; padding: 0.3rem 0.3rem 0.3rem 0.5rem; height: 35px !important;" />
                        </eo:StaticColumn>
                ...
                <div class="text-center">
                    <asp:HyperLink ID="hlkNovo" runat="server" CssClass="btn">Nova Ficha EPI</asp:HyperLink>
                </div>
...
--%>
            <div class="col-12">
                  <asp:Button ID="cmd_Voltar" runat="server"  onclick="cmd_Voltar_Click"
                      CssClass="btn2" Text="Voltar"/>
            </div>
