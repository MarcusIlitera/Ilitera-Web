<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="ListaEmpresa.aspx.cs"  Inherits="Ilitera.Net.ListaEmpresa" Title="Ilitera.Net" %>
...
--%>		<script language="javascript" src="../scripts/validador.js"></script>
		...
		function ListaIrregularidade(IdEmpresa, IdUsuario)
		{		    
		    top.window.document.frames.conteudo.window.document.getElementById('txtIdEmpresa').value = IdEmpresa;
			window.location.href = "ListagemIrregularidades.aspx?IdEmpresa=" + IdEmpresa + "&IdUsuario=" + IdUsuario;
		}
        ...
        function UltraWebGridListaEmpresa_CellClickHandler(gridName, cellId, button)
        {
	        if (button == 0)
	        {
	            ...
	            if (cell.Index == 1)
	                ListaIrregularidade(IdEmpresaCell.getValue(), top.window.document.frames.conteudo.window.document.getElementById('txtIdUsuario').value);
	        }
        }
		</script>
<%--	</HEAD>
												...
												<TABLE class="defaultFont" id="Table2" cellSpacing="0" cellPadding="0" width="370" align="center"
													...
													<TR>
														<TD align="left" width="330"><asp:label id="lblBuscaEmpresa" runat="server" Width="104px" SkinID="BoldFont">Empresa:</asp:label><asp:textbox id="txtEmpresa" runat="server" Width="215px"></asp:textbox><BR>
															<asp:label id="lblBuscaLocalTrab" runat="server" Width="104px" ForeColor="Gray" SkinID="BoldFont">Local de Trabalho:</asp:label><asp:textbox id="txtLocalTrabalho" runat="server" Width="215px" BorderColor="LightGray"
																BackColor="#EBEBEB" ReadOnly="True"></asp:textbox></TD>
														<TD vAlign="middle" align="center" width="40"><asp:imagebutton id="btnLocalizar" runat="server" ImageUrl="img/busca.gif" AlternateText="Localizar"
																BorderWidth="0px" OnClick="btnLocalizar_Click"></asp:imagebutton></TD>
													</TR>
												</TABLE>
											</TD>
											<TD vAlign="middle" align="center" width="230"><asp:checkbox id="ckbEnableLocais" runat="server" Width="185px" AutoPostBack="True"
													Text="Visualizar Locais de Trabalho das Empresas" ToolTip="Visualizar Locais de Trabalho" oncheckedchanged="ckbEnableLocais_CheckedChanged" SkinID="BoldFont"></asp:checkbox></TD>
										</TR>
									</TABLE>
									<TABLE class="defaultFont" id="Table3" cellSpacing="0" cellPadding="0" width="600" align="center"
										border="0">
										<TR>
											<TD align="center"><asp:image id="Image2" runat="server" ImageUrl="img/5pixel.gif"></asp:image><BR>
												...
												</asp:radiobuttonlist><asp:image id="Image1" runat="server" ImageUrl="img/5pixel.gif"></asp:image></TD>
										</TR>
									</TABLE>
								</td>
							</tr>
							<tr>
								<td align="center" colSpan="2"><igtbl:ultrawebgrid id="UltraWebGridListaEmpresa" runat="server" Width="602px" Height="218px" onpageindexchanged="UltraWebGridListaEmpresa_PageIndexChanged"><Bands>
<igtbl:UltraGridBand>
...
<Padding Left="2px"></Padding>
				...
				<tr>
					<td class="defaultFont" align="center">
						...
						<asp:label id="lblError" runat="server" SkinID="ErrorFont"></asp:label><asp:customvalidator id="cvdCaracteres" runat="server" ControlToValidate="txtEmpresa"
							Display="Dynamic" OnServerValidate="cvdCaracteres_ServerValidate"></asp:customvalidator><asp:customvalidator id="cvdLocalTrabalho" runat="server" ControlToValidate="txtLocalTrabalho"
