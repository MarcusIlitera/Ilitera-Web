...
namespace Ilitera.Net
{
    ...
    /// </summary>
    public partial class ListagemAuditorias : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                Ilitera.Opsa.Data.Auditoria auditoria = new Ilitera.Opsa.Data.Auditoria(Convert.ToInt32(Request.QueryString["IdAuditoria"].ToString()));
                ...
                RptAuditoria2 report = new DataSourceAuditoria(cliente, Convert.ToInt32(Request.QueryString["IdAuditoria"].ToString())).GetReport();
