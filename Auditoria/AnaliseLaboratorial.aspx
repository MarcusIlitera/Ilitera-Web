<%@ Page Language="C#"   AutoEventWireup="True"  MasterPageFile="~/Site.Master" CodeBehind="AnaliseLaboratorial.aspx.cs"  Inherits="Ilitera.Net.Analise_Laboratorial" Title="Ilitera.Net" %>
...
--%>		
     ...
     <eo:TabStrip ID="TabStrip1" runat="server" ControlSkinID="None" 
                            ...
                            <topgroup>
                                <Items>
                                    <eo:TabItem Text-Html="Análise Laboratorial">
                                    </eo:TabItem>
                                </Items>
                            </topgroup>
                            <LookItems >
                            ...
                            <eo:MultiPage ID="MultiPage1" runat="server" Height="250" Width="838">

                                <eo:PageView ID="Pageview2" runat="server">


                                            <TABLE class="defaultFont ms-2" cellSpacing="0" cellPadding="0" width="860" align="center">
				                            <TR>
					                            <TD class="defaultFont" align="center" colSpan="1">
                                                    ...
                                                    <eo:Grid ID="grd_Clinicos" runat="server"
                                                        ...
                                                        GridLines="Both" Height="149px" Width="1051px" ItemHeight="30"  KeyField="IdAnalise" PageSize="10" OnItemCommand="grd_Clinicos_ItemCommand" >
                                                                           <ItemStyles>
                                                                            <eo:GridItemStyleSet>
                                                            ...
                                                            <eo:StaticColumn AllowSort="True" DataField="Tipo" HeaderText="Tipo" Name="Tipo" ReadOnly="True" SortOrder="Ascending" Text="" Width="225">
                                                                <CellStyle CssText="background-color:#ffffcc;font-family:Arial;font-size:9pt;font-weight:bold;text-align:center;" />
                                                            </eo:StaticColumn>
                                                            <eo:StaticColumn AllowSort="True" DataField="Manipulador" HeaderText="Manipulador" Name="Manipulador" ReadOnly="True" Width="200">
                                                                <CellStyle CssText="font-size:8pt;text-align:left;" />
                                                            </eo:StaticColumn>
                                                            <eo:StaticColumn AllowSort="True" DataField="Ultima_Analise" HeaderText="Ultima_Analise" Name="Ultima_Analise" ReadOnly="True" Width="140">
                                                                <CellStyle CssText="font-size:8pt;text-align:center;" />
                                                            </eo:StaticColumn>
                                                            <eo:StaticColumn AllowSort="True" DataField="Resultado" HeaderText="Resultado" Name="Resultado" ReadOnly="True" Width="260">
                                                                <CellStyle CssText="font-size:8pt;text-align:left;" />
                                                            </eo:StaticColumn>
                                                            <eo:ButtonColumn ButtonText="Editar" Name="Selecionar" Width="75">
                                                                <CellStyle CssText="font-family:Tahoma;font-size:7pt;text-align:center" />
                                                            </eo:ButtonColumn>
                                                            <eo:ButtonColumn ButtonText="Visualizar" Name="Selecionar" Width="75">
                                                                <CellStyle CssText="font-family:Tahoma;font-size:7pt;text-align:center" />
                                                            </eo:ButtonColumn>
                                                        </Columns>
                                                        <columntemplates>
                                                    ...
                                                    <br />
                                                    <asp:button id="btnIncluirNovo" runat="server" CssClass="btn" Width="210px" Text="Nova Análise" ></asp:button>
                                                    <asp:HyperLink ID="hlkNovo" runat="server" SkinID="BoldLink">Nova Análise</asp:HyperLink>
