...
namespace Ilitera.Net
{
	...
	/// </summary>
    public partial class AuditoriaReport : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                RptAuditoria2 report;

                if (Request.QueryString["IdIrregularidade"].ToString().Trim() == "0")
                {
                    report = new DataSourceAuditoria(cliente, Convert.ToInt32(Request.QueryString["IdAuditoria"])).GetReport();
                }
                else
                {
                    report = new DataSourceAuditoria(cliente, Convert.ToInt32(Request.QueryString["IdAuditoria"]), Convert.ToInt32(Request.QueryString["IdIrregularidade"])).GetReport();
                }

                Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType(), string.Empty, "Irregularidade");
