...
namespace Ilitera.Net
{
	...
	/// 
	/// </summary>
	public partial class RelatAbsenteismo: System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                RptAbsenteismo report = new DataSourceAbsenteismo(Convert.ToInt32(Request["IdEmpregado"]), Request["Data1"].ToString(), Request["Data2"].ToString()).GetReport();
