...
namespace Ilitera.Opsa.Report {
    ...
    public class RptEtiquetaMod4 : ReportClass {
        
        public RptEtiquetaMod4() {
        }
        
        public override string ResourceName {
            get {
                return "RptEtiquetaMod4.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.Opsa.Report.RptEtiquetaMod4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptEtiquetaMod4 : Component, ICachedReport {
        
        public CachedRptEtiquetaMod4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptEtiquetaMod4 rpt = new RptEtiquetaMod4();
            rpt.Site = this.Site;
            return rpt;
        }
