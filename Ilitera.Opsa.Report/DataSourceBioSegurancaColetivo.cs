...
{
	public class DataSourceBioSegurancaColetivo
	{
		...
		static DataSourceBioSegurancaColetivo()
		{
		...
		public DataSourceBioSegurancaColetivo(int IdGHE)
		{
			alTopicos = new TopicoBioSeguranca().Find("IdGHE=" +IdGHE + " ORDER BY Sequencia");

			if (alTopicos.Count.Equals(0))
				throw new Exception("O Manual de BioSegurança para o GHE selecionado ainda não está disponível!");
			
			// Create a document and set it's properties
			document = new Document();
			document.Creator = "Ilitera.NET";
			document.Author = "Ilitera.NET";
			document.Title = "Manual Coletivo de BioSegurança";
		...
		private void GetCapa()
		{
            ...
            //Label tipoManual = new Label("Coletivo", 0F, 550F, 515F, 200F, Font.TimesBold, 44F, TextAlign.Center, Color.DarkRed);
