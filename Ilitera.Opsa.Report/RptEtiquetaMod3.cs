...
namespace Ilitera.Opsa.Report {
    ...
    public class RptEtiquetaMod3 : ReportClass {
        
        public RptEtiquetaMod3() {
        }
        
        public override string ResourceName {
            get {
                return "RptEtiquetaMod3.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Ilitera.Opsa.Report.RptEtiquetaMod3.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptEtiquetaMod3 : Component, ICachedReport {
        
        public CachedRptEtiquetaMod3() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptEtiquetaMod3 rpt = new RptEtiquetaMod3();
            rpt.Site = this.Site;
            return rpt;
        }
