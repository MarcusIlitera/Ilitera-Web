...
namespace Ilitera.Net.OrdemDeServico
{
	...
	///
	/// </summary>
	public partial class RptListaProcOS : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
                ...
                ReportListaProcOS report = new Ilitera.OrdemServico.Report.DataSourceOrdemDeServico(empregado, Convert.ToDateTime(Request["DataOS"], ptBr)).GetReportListaProcOS();
