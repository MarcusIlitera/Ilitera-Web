...
namespace Ilitera.Net.OrdemDeServico
{
	...
	/// 
	/// </summary>
	public partial class RptConjuntoProcedimento : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
				ReportConjuntoDeProcedimentos report = new DataSourceConjuntoProc().GetReportConjProc(xCliente);
