...
namespace Ilitera.Net.OrdemDeServico
{
	...
	///
	/// </summary>
	public partial class RptPOPGenerico : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
				...
				ReportPOPGenerico report = new DataSourceOrdemDeServico(empregado, Convert.ToDateTime(Request["DataOS"], ptBr)).GetReportPOPGenerico();

                Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType(), string.Empty, "ProcedimentosInstrutivos");
