...
namespace Ilitera.Net.OrdemDeServico
{
	...
	///
	/// </summary>
	public partial class RptProcedimento : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			//InicializaWebPageObjects();

			Procedimento procedimento = new Procedimento(Convert.ToInt32(Request["IdProcedimento"]));
            ...
            if (zImpressao == "V")
            {
                try
                {
                    ReportClass report = new DataSourceOrdemDeServico().GetReportProcedimento_Vertical(procedimento);
            ...
            else
            {
                try
                {
                    ReportClass report = new DataSourceOrdemDeServico().GetReportProcedimento(procedimento);
