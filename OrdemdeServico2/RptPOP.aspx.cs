...
namespace Ilitera.Net.OrdemDeServico
{
	...
	///
	/// </summary>
	public partial class RptPOP : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                ReportPOP4 report = new Ilitera.OrdemServico.Report.DataSourceOrdemDeServico(empregado, Convert.ToDateTime(Request["DataOS"], ptBr)).GetReportPOP();

                Funcionalidade funcionalidade = Funcionalidade.GetFuncionalidade(FuncionalidadeTipo.Relatorio, report.GetType(), string.Empty, "ProcedimentosEspecificos");
