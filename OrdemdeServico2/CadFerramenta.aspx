<%@ Page language="c#" Inherits="Ilitera.Net.OrdemDeServico.CadFerramenta" Codebehind="CadFerramenta.aspx.cs" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form method="post" runat="server">
			<TABLE class="normalFont" id="Table1" cellSpacing="0" cellPadding="0" width="400" align="center"
				...
				<TR>
					<TD align="center"><BR>
						<asp:label id="lblCadEqui" runat="server" CssClass="largeboldFont">Cadastro e Edição de Ferramentas</asp:label><BR>
						<BR>
						<asp:listbox id="lsbFerramentas" runat="server" CssClass="inputBox" Width="380px" Rows="8" AutoPostBack="True" onselectedindexchanged="lsbFerramentas_SelectedIndexChanged"></asp:listbox><BR>
						<BR>
						...
						<BR>
						<asp:label id="Label2" runat="server" CssClass="boldFont">Descrição da Ferramenta</asp:label><BR>
						<asp:textbox id="txtDescricao" runat="server" CssClass="inputBox" Width="360px" Rows="4" TextMode="MultiLine"></asp:textbox><BR>
						<BR>
