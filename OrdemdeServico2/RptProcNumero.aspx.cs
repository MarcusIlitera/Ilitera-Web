...
namespace Ilitera.Net.OrdemDeServico
{
	...
	/// 
	/// </summary>
	public partial class RptProcNumero : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
				RptListaProcedimentos report = new DataSourceListaProcedimento(xCliente, true).GetReportListaProcedimento();
