...
namespace Ilitera.Net.ControleCIPA
{
	...
	public partial class RelatorioAnual : System.Web.UI.Page
	{		
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
			{
				...
				eventoCipa.Find("IdEventoBaseCipa=" + (int)EventoBase.Calendario + " AND IdCipa=" + Request.QueryString["IdCipa"]);

                RptCalendario report = new DataSourceCipa(eventoCipa).GetReportCalendario();
