...
{
    public partial class Repositorio_Cadastro : System.Web.UI.Page
    {

        protected System.Web.UI.HtmlControls.HtmlTableCell TDGridListaEmpresa;
        protected Ilitera.Opsa.Data.Repositorio xRepositorio;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!xRepositorio.Id.Equals(0))
                {
                    ...
                    if ( xRepositorio.nId_Laud_Tec != null && xRepositorio.nId_Laud_Tec != 0)
                    {
                        btnExcluir.Visible = false;
                        btnOK.Visible = false;
                    }
        ...
        protected void InicializaWebPageObjects()
        {
            ...
            if (Request["IdRepositorio"].ToString().Trim() != "0")
            {
                xRepositorio = new Ilitera.Opsa.Data.Repositorio();
                xRepositorio.Find(Convert.ToInt32(Request["IdRepositorio"]));
            }
            else
            {
                xRepositorio = new Ilitera.Opsa.Data.Repositorio();
                xRepositorio.Inicialize();
                xRepositorio.IdCliente = Convert.ToInt32(Request["Empresa"]);
            }
        }
        ...
        {
            btnExcluir.Attributes.Add("onClick", "javascript:return(confirm('Deseja realmente excluir este registro de documento/laudo?'))");
        }
        ...
        public void PopulaTelaExame()
        {
            ...
            rd_Documento.SelectedValue = xRepositorio.TipoDocumento;
        ...
        protected void btnOK_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                xRepositorio.TipoDocumento = rd_Documento.SelectedValue.ToString().Trim();

                xRepositorio.IdCliente = System.Convert.ToInt32(Session["Empresa"].ToString());
                xRepositorio.Save();
                ...
                if (File1.FileName != string.Empty)
                {
                    ...
                    string xExtension2 = File1.FileName.Substring(File1.FileName.Length - 4, 4).ToUpper().Trim();

                    if (xExtension == "PDF" || xExtension == "JPG" || xExtension == "XLS" || xExtension2 == "XLSX")
                    {
                ...
                st.Append("window.alert('Dados de documento/laudo foram salvos com sucesso!');");
                ...
                Response.Redirect("Repositorio.aspx?IdEmpresa=" + Session["Empresa"].ToString() + "&IdUsuario=" + user.IdUsuario.ToString() + "&Tipo=3");
        ...
        protected void btnExcluir_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                st.Append("window.opener.document.getElementById('txtAuxiliar').value='atualiza';");
                st.Append("window.opener.document.forms[0].submit();");
                st.Append("window.alert('Registro de documento deletado com sucesso!');");
        ...
        private void Carregar_Imagem()
        {
            ...
            else
            {
                ...
                else if (xPath.ToUpper().IndexOf(".XLS") > 0)
                {
                    cmd_Imagem.Visible = false;
                    ImgFunc.Visible = false;
                    cmd_PDF.Visible = true;
        ...
        protected void rd_Documento_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void cmd_PDF_Click(object sender, EventArgs e)
        {
            ...
            if (lbl_Path.Text.ToUpper().IndexOf(".XLS") > 0)
            {
                string xPath = lbl_Path.Text;
                HttpContext.Current.Response.ContentType = "application/vnd.ms-excel";
                String Header = "Attachment; Filename=" + System.IO.Path.GetFileName(xPath);
                HttpContext.Current.Response.AppendHeader("Content-Disposition", Header);
                System.IO.FileInfo Dfile = new System.IO.FileInfo(xPath); //HttpContext.Current.Server.MapPath(myStringWebResource));
                HttpContext.Current.Response.WriteFile(Dfile.FullName);
                HttpContext.Current.Response.End();

            }
            else if (lbl_Path.Text != "")
            {
