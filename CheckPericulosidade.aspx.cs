...
{
    public partial class CheckPericulosidade : System.Web.UI.Page
    {
        ...
        private void PopulaDDLLaudos()
        {
            ...
            DataSet ds = xEPI.Trazer_Laudo_Periculosidade( System.Convert.ToInt32( Session["Empresa"].ToString() )  );
