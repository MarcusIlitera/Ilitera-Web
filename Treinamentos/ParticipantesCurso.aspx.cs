...
namespace Ilitera.Net.Treinamentos
{
	...
	///
	/// </summary>
	public partial class ParticipantesCurso : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				RptParticipantesCurso report = new DataSouceParticipantesCurso(treinamento).GetReport();
