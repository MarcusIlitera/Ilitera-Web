...
namespace Ilitera.Net
{
	...
	///
	/// </summary>
	public partial class PCMSOPorEmpregado : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{				
				...
				RptExamePlanPorEmpregado report = new DataSourceExamePlanejamento(pcmso).GetReportExamePorEmpregado();
