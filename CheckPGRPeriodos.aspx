<%@ Page Title="Ilitera.Net" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True"    CodeBehind="CheckPGRPeriodos.aspx.cs" Inherits="Ilitera.Net.CheckPGRPeriodos" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div runat="server" class="container-fluid d-flex ms-5 ps-4">
        <%-- PGR --%>
           <div runat="server" class="row gx-3 gy-2 w-100">
            <div class="col-11">
                <div>
            <%-- Data do Laudo --%>
            <div runat="server" class="margemDataLaudo wrapperSelect">
                <fieldset>
            ...
            <div runat="server" class="row centralizar margemBotoes">
                    <div runat="server" class="row centralizar botoes">
                        <asp:Button ID="btnIntroducao" runat="server" CssClass="btn" Text="PGR - Introdução" OnClick="lkbIntroducao_Click" />
                        <asp:Button ID="btnPlanilha" runat="server" CssClass="btn" Text="PGR - Inventário de Riscos" OnClick="lkbPlanilha_Click" />
                    </div>
                    <div runat="server" class="row centralizar botoes">
                        <asp:Button ID="btnPPRA" runat="server" CssClass="btn" Text="PGR Completo" OnClick="lkbPPRA_Click" />
                        <asp:Button ID="btnPGRTR" runat="server" CssClass="btn" Text="PGRTR Completo" OnClick="lkbPGRTR_Click" />
                    </div>
                </div>
            </div>
        <%-- Certificado com Assinatura Digital --%>

        <div runat="server" class="row remendo margens align-items-center">
            <%-- Título --%>
            ...
            <eo:Grid ID="grd_Clinicos" runat="server" FixedColumnCount="1" GridLines="Both" ColumnHeaderDividerOffset="6"
                ...
                <Columns>
                    <eo:StaticColumn AllowSort="True" DataField="DataHora" HeaderText="Data do Documento" Name="DataHora" ReadOnly="True" SortOrder="Ascending" Text="" Width="200" DataFormat="{0:dd/MM/yyyy}" DataType="DateTime">
                        <CellStyle CssText="font-family: 'Ubuntu'; font-size: 12px; font-weight: 500; color: #7D7B7B; padding: 0.3rem 0.3rem 0.3rem 0.5rem; text-align: left; height: 30px !important; " />
                    </eo:StaticColumn>
